...
function createBuildWithAIElement(themeDiv) {
  ...
  buildWithAIElement.addEventListener('click', () => {
    window.location.href = window.nfdOnboardingRestartMeta?.buttonHref + '&restart=theme';
  });
...
((window.newfold = window.newfold || {}).Onboarding = window.newfold.Onboarding || {})["onboarding-restart-button"] = __webpack_exports__;
/******/ })()
;
//# sourceMappingURL=onboarding-restart-button.js.map
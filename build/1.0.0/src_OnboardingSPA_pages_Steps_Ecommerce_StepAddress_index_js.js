"use strict";
(self["webpackChunknewfold_Onboarding"] = self["webpackChunknewfold_Onboarding"] || []).push([["src_OnboardingSPA_pages_Steps_Ecommerce_StepAddress_index_js"],{
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../store */ "./src/OnboardingSPA/store/index.js");
/* harmony import */ var _content_json__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../content.json */ "./src/OnboardingSPA/pages/Steps/Ecommerce/content.json");
/* harmony import */ var _countries_json__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../countries.json */ "./src/OnboardingSPA/pages/Steps/Ecommerce/countries.json");
/* harmony import */ var _currencies_json__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../currencies.json */ "./src/OnboardingSPA/pages/Steps/Ecommerce/currencies.json");
/* harmony import */ var _useWPSettings__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../useWPSettings */ "./src/OnboardingSPA/pages/Steps/Ecommerce/useWPSettings.js");
/* harmony import */ var _components_StateHandlers__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../components/StateHandlers */ "./src/OnboardingSPA/components/StateHandlers/index.js");
...
const StepAddress = () => {
  var _ref, _address$woocommerce_, _address$country, _countries$find$state, _countries$find;
  ...
  let currentData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select(_store__WEBPACK_IMPORTED_MODULE_10__.store).getCurrentOnboardingData());
  const settings = (0,_useWPSettings__WEBPACK_IMPORTED_MODULE_14__.useWPSettings)();
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    let addressKeys = ['woocommerce_store_address', 'woocommerce_store_city', 'woocommerce_store_postcode', 'woocommerce_default_country', 'woocommerce_currency', 'woocommerce_email_from_address'];
  ...
  let defaultPlace = (_ref = (_address$woocommerce_ = address === null || address === void 0 ? void 0 : address.woocommerce_default_country) !== null && _address$woocommerce_ !== void 0 ? _address$woocommerce_ : settings === null || settings === void 0 ? void 0 : settings.woocommerce_default_country) !== null && _ref !== void 0 ? _ref : 'US:AZ';
  let [defaultCountry, defaultState] = defaultPlace.split(':');
  let selectedCountry = (_address$country = address === null || address === void 0 ? void 0 : address.country) !== null && _address$country !== void 0 ? _address$country : defaultCountry;
  let states = (_countries$find$state = _countries_json__WEBPACK_IMPORTED_MODULE_12__ === null || _countries_json__WEBPACK_IMPORTED_MODULE_12__ === void 0 ? void 0 : (_countries$find = _countries_json__WEBPACK_IMPORTED_MODULE_12__.find(country => country.code === selectedCountry)) === null || _countries$find === void 0 ? void 0 : _countries$find.states) !== null && _countries$find$state !== void 0 ? _countries$find$state : [];
  ...
  function handleFieldChange(event) {
    ...
    if (['country', 'state'].includes(fieldName)) {
      place = fieldName === 'country' ? state ? `${newValue}:${state}` : newValue : `${country}:${newValue}`;
    }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_StateHandlers__WEBPACK_IMPORTED_MODULE_15__.EcommerceStateHandler, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_Layouts_Common__WEBPACK_IMPORTED_MODULE_7__["default"], {
    isBgPrimary: true,
    isCentered: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_NewfoldLargeCard__WEBPACK_IMPORTED_MODULE_9__["default"], {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_CardHeader__WEBPACK_IMPORTED_MODULE_6__["default"], {
    heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(_content_json__WEBPACK_IMPORTED_MODULE_11__.stepAddressHeading, 'wp-module-onboarding'),
    subHeading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(_content_json__WEBPACK_IMPORTED_MODULE_11__.stepAddressSubHeading, 'wp-module-onboarding')
  }), settings === null && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", null, "Loading your details...")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "store-address-form"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    "data-name": "country"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("label", {
    "aria-required": true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Where is your store based?', 'wp-module-onboarding')), settings === null ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", {
    type: "text",
    disabled: true
  ...
  }, fieldProps), _countries_json__WEBPACK_IMPORTED_MODULE_12__.map(country => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("option", {
    key: country.code,
    value: country.code
    ...
    "aria-required": true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Address', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    "aria-required": true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('City', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    name: "woocommerce_store_city",
    type: "text",
    required: true,
    defaultValue: address === null || address === void 0 ? void 0 : address.woocommerce_store_city
  }, fieldProps))), states.length === 0 || settings === null ? null : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    "data-name": "state"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("label", {
    "aria-required": true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('State', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("select", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    type: "text",
    name: "state",
    required: true,
    ...
    "aria-required": true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Postal Code', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    "aria-required": true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Email', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
  ...
  }, fieldProps), Object.entries(_currencies_json__WEBPACK_IMPORTED_MODULE_13__).map(_ref2 => {
  ...
  }, "* required")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("button", {
    className: "nfd-nav-card-button nfd-card-button",
    disabled: settings === null,
    type: "submit"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(_content_json__WEBPACK_IMPORTED_MODULE_11__.buttonText, 'wp-module-onboarding'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_components_NeedHelpTag__WEBPACK_IMPORTED_MODULE_8__["default"], null)))));
};

/* harmony default export */ __webpack_exports__["default"] = (StepAddress);

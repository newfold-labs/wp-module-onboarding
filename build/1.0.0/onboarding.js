...
const createBorderGenerateFunction = individualProperty => (style, options) => {
  ...
  return borderDefinitionsWithIndividualStyles.reduce((acc, borderDefinition) => {
    ...
    if (styleValue.hasOwnProperty(key) && typeof borderDefinition.generate === 'function') {
      const ruleKey = `border${(0,_utils__WEBPACK_IMPORTED_MODULE_0__.upperFirst)(individualProperty)}${(0,_utils__WEBPACK_IMPORTED_MODULE_0__.upperFirst)(key)}`;
...
/* harmony default export */ __webpack_exports__["default"] = ([...borderDefinitionsWithIndividualStyles, radius, borderTop, borderRight, borderBottom, borderLeft]);
//# sourceMappingURL=index.js.map
...
/* harmony import */ var _spacing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./spacing */ "./node_modules/@wordpress/style-engine/build-module/styles/spacing/index.js");
/* harmony import */ var _typography__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./typography */ "./node_modules/@wordpress/style-engine/build-module/styles/typography/index.js");
/**
 * Internal dependencies
 */
...
const styleDefinitions = [..._border__WEBPACK_IMPORTED_MODULE_0__["default"], ..._color__WEBPACK_IMPORTED_MODULE_1__["default"], ..._spacing__WEBPACK_IMPORTED_MODULE_2__["default"], ..._typography__WEBPACK_IMPORTED_MODULE_3__["default"]];
//# sourceMappingURL=index.js.map
...
/* harmony default export */ __webpack_exports__["default"] = ([fontSize, fontStyle, fontWeight, letterSpacing, lineHeight, textDecoration, textTransform]);
//# sourceMappingURL=index.js.map
...
function getCSSVarFromStyleValue(styleValue) {
  if (typeof styleValue === 'string' && styleValue.startsWith(_constants__WEBPACK_IMPORTED_MODULE_1__.VARIABLE_REFERENCE_PREFIX)) {
    const variable = styleValue.slice(_constants__WEBPACK_IMPORTED_MODULE_1__.VARIABLE_REFERENCE_PREFIX.length).split(_constants__WEBPACK_IMPORTED_MODULE_1__.VARIABLE_PATH_SEPARATOR_TOKEN_ATTRIBUTE).join(_constants__WEBPACK_IMPORTED_MODULE_1__.VARIABLE_PATH_SEPARATOR_TOKEN_STYLE);
...
const App = () => {
  ...
  async function syncSocialSettings() {
    ...
    const result = await (0,_utils_api_settings__WEBPACK_IMPORTED_MODULE_7__.setSettings)(currentData === null || currentData === void 0 ? void 0 : (_currentData$data = currentData.data) === null || _currentData$data === void 0 ? void 0 : _currentData$data.socialData);
  ...
  async function syncStoreToDB() {
    ...
    if (currentData && !isFirstStep) {
      if (!isRequestPlaced) {
        ...
        if (didVisitBasicInfo) {
          const socialData = await syncSocialSettings(); // If Social Data is changed then Sync that also to the store

          if (socialData && currentData !== null && currentData !== void 0 && currentData.data) currentData.data.socialData = socialData;
        }

        const result = await (0,_utils_api_flow__WEBPACK_IMPORTED_MODULE_6__.setFlow)(currentData);

        if ((result === null || result === void 0 ? void 0 : result.error) != null) {
          setIsRequestPlaced(false);
          console.error('Unable to Save data!');
        } else {
          setCurrentOnboardingData(result === null || result === void 0 ? void 0 : result.body);
          setIsRequestPlaced(false);
        }
      }
    ...
    if (location !== null && location !== void 0 && location.pathname.includes('basic-info')) setDidVisitBasicInfo(true);
  ...
  function handleColorsAndTypographyRoutes() {
    if (location !== null && location !== void 0 && location.pathname.includes('colors') || location !== null && location !== void 0 && location.pathname.includes('typography')) {
      ...
      let updates;
      updates = currentData !== null && currentData !== void 0 && (_currentData$data2 = currentData.data) !== null && _currentData$data2 !== void 0 && _currentData$data2.customDesign ? addColorAndTypographyRoutes() : removeColorAndTypographyRoutes();
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_interface__WEBPACK_IMPORTED_MODULE_15__.FullscreenMode, {
    isActive: true
  }), "\\", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_14__.SlotFillProvider, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_interface__WEBPACK_IMPORTED_MODULE_15__.InterfaceSkeleton, {
...
const Content = () => {
  ...
  const getMappedPages = routes => {
    return routes === null || routes === void 0 ? void 0 : routes.map(route => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, {
      key: route.path,
      path: route.path,
      end: true,
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Routes, null, getMappedPages(routes))));
};
...
const DesignColors = () => {
  ...
  const [selectedColors, setSelectedColors] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)();
  ...
  function stateToLocal(selectedColors) {
    if (selectedColors) {
      var _selectedColors$color;

      const selectedColorsLocalTemp = {};
      selectedColors === null || selectedColors === void 0 ? void 0 : (_selectedColors$color = selectedColors.color) === null || _selectedColors$color === void 0 ? void 0 : _selectedColors$color.forEach(color => {
  ...
  function LocalToState(selectedColorsLocalTemp, colorStyle) {
    if (selectedColorsLocalTemp && colorStyle) {
      ...
      selectedColors.name = (colorStyle === null || colorStyle === void 0 ? void 0 : colorStyle.charAt(0).toUpperCase()) + (colorStyle === null || colorStyle === void 0 ? void 0 : colorStyle.slice(1));
      const colorsArray = [];
  ...
  async function saveThemeColorPalette(colorStyle) {
    var _selectedGlobalStyle$, _selectedGlobalStyle$2, _selectedThemeColorPa, _selectedThemeColorPa2, _colorPalettesTemp$co, _colorPalettesTemp$co2;
    ...
    let globalStylesTemp = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : storedPreviewSettings;
    ...
    if (colorPalettesTemp && colorStyle && selectedThemeColorPalette) {
      for (let idx = 0; idx < selectedThemeColorPalette.length; idx++) {
        switch ((_selectedThemeColorPa = selectedThemeColorPalette[idx]) === null || _selectedThemeColorPa === void 0 ? void 0 : _selectedThemeColorPa.slug) {
          ...
          case 'secondary-foreground':
            const slug = (_selectedThemeColorPa2 = selectedThemeColorPalette[idx]) === null || _selectedThemeColorPa2 === void 0 ? void 0 : _selectedThemeColorPa2.slug;
            if (isCustomStyle && (selectedColorsLocalTemp === null || selectedColorsLocalTemp === void 0 ? void 0 : selectedColorsLocalTemp[slug]) != '') selectedThemeColorPalette[idx].color = selectedColorsLocalTemp[slug];
            /**
             * Add Exception for Background.
             * (perhaps scope to yith-wonder in future)
             */
            else if (colorPalettesTemp !== null && colorPalettesTemp !== void 0 && (_colorPalettesTemp$co = colorPalettesTemp[colorStyle]) !== null && _colorPalettesTemp$co !== void 0 && _colorPalettesTemp$co[slug] && 'background' === slug) {
              selectedThemeColorPalette[idx].color = '#FFFFFF';
            } else if (!isCustomStyle && colorPalettesTemp !== null && colorPalettesTemp !== void 0 && (_colorPalettesTemp$co2 = colorPalettesTemp[colorStyle]) !== null && _colorPalettesTemp$co2 !== void 0 && _colorPalettesTemp$co2[slug]) {
              selectedThemeColorPalette[idx].color = colorPalettesTemp[colorStyle][slug];
            }
            break;
        }
      }
      ...
      updatePreviewSettings((0,_utils_global_styles_use_global_styles_output__WEBPACK_IMPORTED_MODULE_6__.useGlobalStylesOutput)(selectedGlobalStyle, storedPreviewSettings));
      return selectedGlobalStyle;
    }
  }

  async function saveCustomColors() {
    var _selectedGlobalStyle$3, _selectedGlobalStyle$4, _selectedThemeColorPa3;

    const selectedGlobalStyle = storedPreviewSettings;
    const selectedThemeColorPalette = selectedGlobalStyle === null || selectedGlobalStyle === void 0 ? void 0 : (_selectedGlobalStyle$3 = selectedGlobalStyle.settings) === null || _selectedGlobalStyle$3 === void 0 ? void 0 : (_selectedGlobalStyle$4 = _selectedGlobalStyle$3.color) === null || _selectedGlobalStyle$4 === void 0 ? void 0 : _selectedGlobalStyle$4.palette;

    if (selectedThemeColorPalette) {
      for (let idx = 0; idx < selectedThemeColorPalette.length; idx++) {
        switch ((_selectedThemeColorPa3 = selectedThemeColorPalette[idx]) === null || _selectedThemeColorPa3 === void 0 ? void 0 : _selectedThemeColorPa3.slug) {
          case 'background':
            if (colorPickerCalledBy == 'background' && customColors !== null && customColors !== void 0 && customColors.background) selectedThemeColorPalette[idx].color = customColors === null || customColors === void 0 ? void 0 : customColors.background;
            break;

          case 'primary':
            if (colorPickerCalledBy == 'primary' && customColors !== null && customColors !== void 0 && customColors.primary) selectedThemeColorPalette[idx].color = customColors === null || customColors === void 0 ? void 0 : customColors.primary;
            break;

          case 'secondary':
            if (colorPickerCalledBy == 'secondary' && customColors !== null && customColors !== void 0 && customColors.secondary) selectedThemeColorPalette[idx].color = customColors === null || customColors === void 0 ? void 0 : customColors.secondary;
            break;

          case 'tertiary':
            if (colorPickerCalledBy == 'tertiary' && customColors !== null && customColors !== void 0 && customColors.tertiary) selectedThemeColorPalette[idx].color = customColors === null || customColors === void 0 ? void 0 : customColors.tertiary;
            break;
        }
      }
  ...
  const getColorStylesAndPatterns = async () => {
    var _currentData$data, _currentData$data$pal, _currentData$data2;
    ...
    if (!(currentData !== null && currentData !== void 0 && (_currentData$data = currentData.data) !== null && _currentData$data !== void 0 && (_currentData$data$pal = _currentData$data.palette) !== null && _currentData$data$pal !== void 0 && _currentData$data$pal.slug) === '') {
    ...
    setSelectedColors(selectedColors);
    saveThemeColorPalette(currentData === null || currentData === void 0 ? void 0 : (_currentData$data2 = currentData.data) === null || _currentData$data2 === void 0 ? void 0 : _currentData$data2.palette.slug, colorPalettes === null || colorPalettes === void 0 ? void 0 : colorPalettes.body, selectedColorsLocal, storedPreviewSettings);
    setIsLoaded(true);
  };
  ...
  const handleClick = colorStyle => {
    ...
    for (const custom in customColorsTemp) customColorsTemp[custom] = '';
  ...
  const selectCustomColor = colorType => {
    ...
    if (!showColorPicker) setColorPickerCalledBy(colorType);else setColorPickerCalledBy('');
  };

  async function resetColors() {
    var _currentData$data3, _currentData$data3$th, _globalStyles$body$;

    const globalStyles = await (0,_utils_api_themes__WEBPACK_IMPORTED_MODULE_5__.getGlobalStyles)();
    let selectedGlobalStyle;

    if (currentData !== null && currentData !== void 0 && (_currentData$data3 = currentData.data) !== null && _currentData$data3 !== void 0 && (_currentData$data3$th = _currentData$data3.theme) !== null && _currentData$data3$th !== void 0 && _currentData$data3$th.variation) {
    ...
    for (const colorVal in selectedColors === null || selectedColors === void 0 ? void 0 : selectedColors.color) selectedColors.color[colorVal].color = '';
  ...
  function buildPalettes() {
    ...
    for (const colorStyle in colorPalettes) {
      var _colorPalettes$colorS, _colorPalettes$colorS2, _colorPalettes$colorS3;

      paletteRenderedList.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        key: colorStyle,
        className: `color-palette ${colorStyle == (selectedColors === null || selectedColors === void 0 ? void 0 : selectedColors.slug) ? 'color-palette-selected' : ''} `,
        ...
        style: {
          backgroundColor: `${(_colorPalettes$colorS = colorPalettes[colorStyle]) === null || _colorPalettes$colorS === void 0 ? void 0 : _colorPalettes$colorS.tertiary}`
        }
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "color-palette__colors--secondary",
        style: {
          backgroundColor: `${(_colorPalettes$colorS2 = colorPalettes[colorStyle]) === null || _colorPalettes$colorS2 === void 0 ? void 0 : _colorPalettes$colorS2.secondary}`
        }
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "color-palette__colors--primary",
        style: {
          backgroundColor: `${(_colorPalettes$colorS3 = colorPalettes[colorStyle]) === null || _colorPalettes$colorS3 === void 0 ? void 0 : _colorPalettes$colorS3.primary}`
        }
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "color-palette__name"
      }, (colorStyle === null || colorStyle === void 0 ? void 0 : colorStyle.charAt(0).toUpperCase()) + (colorStyle === null || colorStyle === void 0 ? void 0 : colorStyle.slice(1)))));
    }
  ...
  function buildCustomPalette() {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, "SELECT CUSTOM COLORS"), isAccordionClosed && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-palette__top-icon"
    }, "+"), !isAccordionClosed && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-palette__top-icon"
    }, "-")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: `custom-palette__below-row-icon ${(customColors === null || customColors === void 0 ? void 0 : customColors.background) && 'custom-palette__below-row-icon_selected_border'}`,
      style: {
        backgroundColor: `${(_customColors$backgro = customColors === null || customColors === void 0 ? void 0 : customColors.background) !== null && _customColors$backgro !== void 0 ? _customColors$backgro : '#FFF'}`
      }
    }, customColors !== null && customColors !== void 0 && customColors.background ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, "\u2713") : null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "custom-palette__below-row-text"
    }, "Primary")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-palette__below-row",
      ...
      className: "custom-palette__below-row-text"
    }, "Secondary")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-palette__below-row",
      ...
      className: "custom-palette__below-row-text"
    }, "Tertiary"))), showColorPicker && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Popover, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-palette__picker-close-icon",
      onClick: () => setShowColorPicker(false)
    }, "X"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ColorPicker, {
      onChange: changeCustomPickerColor,
      defaultValue: "#874141"
    })));
  }

  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_LivePreview__WEBPACK_IMPORTED_MODULE_7__.GlobalStylesProvider, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme-colors--drawer"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Color Palettes', 'wp-module-onboarding')), colorPalettes && buildPalettes(), colorPalettes && buildCustomPalette()));
};
...
/* harmony import */ var _HeaderMenuPreview__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../HeaderMenuPreview */ "./src/OnboardingSPA/components/HeaderMenuPreview/index.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../store */ "./src/OnboardingSPA/store/index.js");
/* harmony import */ var _utils_api_patterns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../utils/api/patterns */ "./src/OnboardingSPA/utils/api/patterns.js");
...
const DesignHeaderMenu = () => {
  const headerMenuSlugs = ['yith-wonder/site-header-left-logo-navigation-inline', 'yith-wonder/site-header-left-logo-navigation-below', 'yith-wonder/site-header-centered', 'yith-wonder/site-header-splitted-menu'];
  ...
  const getPatternsData = async () => {
    const headerMenuPreviewResponse = await (0,_utils_api_patterns__WEBPACK_IMPORTED_MODULE_4__.getPatterns)(currentStep.patternId);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!isLoaded && themeStatus === _constants__WEBPACK_IMPORTED_MODULE_6__.THEME_STATUS_ACTIVE) getPatternsData();
  ...
  const buildPreviews = () => {
    return patterns === null || patterns === void 0 ? void 0 : patterns.map((pattern, idx) => {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_HeaderMenuPreview__WEBPACK_IMPORTED_MODULE_2__["default"], {
        key: idx,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_LivePreview__WEBPACK_IMPORTED_MODULE_5__.GlobalStylesProvider, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme-header-menu-preview--drawer"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme-header-menu-preview--drawer__list"
  }, buildPreviews())));
};

/* harmony default export */ __webpack_exports__["default"] = (DesignHeaderMenu);
...
/* harmony default export */ __webpack_exports__["default"] = (DesignHomepageMenu);
...
/* harmony default export */ __webpack_exports__["default"] = (DesignThemeStylesMenu);
...
const DesignThemeStylesPreview = () => {
  ...
  const getStylesAndPatterns = async () => {
    ...
    if (document.getElementsByClassName('theme-styles-preview--drawer__list__item__title-bar--selected')) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!isLoaded && themeStatus === _constants__WEBPACK_IMPORTED_MODULE_6__.THEME_STATUS_ACTIVE) getStylesAndPatterns();
  }, [isLoaded, themeStatus]);

  const handleClick = idx => {
    const selectedGlobalStyle = globalStyles[idx];
    updatePreviewSettings((0,_utils_global_styles_use_global_styles_output__WEBPACK_IMPORTED_MODULE_5__.useGlobalStylesOutput)(selectedGlobalStyle, storedPreviewSettings));
...
/* harmony default export */ __webpack_exports__["default"] = (DesignThemeStylesPreview);
...
/* harmony default export */ __webpack_exports__["default"] = (DesignThemes);
...
const DesignTypography = () => {
  ...
  const getFontStylesAndPatterns = async () => {
    var _currentData$data, _currentData$data$typ, _storedPreviewSetting, _storedPreviewSetting2;

    const fontPalettes = await (0,_utils_api_themes__WEBPACK_IMPORTED_MODULE_5__.getThemeFonts)();
    setFontPalettes(fontPalettes === null || fontPalettes === void 0 ? void 0 : fontPalettes.body);

    if ((currentData === null || currentData === void 0 ? void 0 : (_currentData$data = currentData.data) === null || _currentData$data === void 0 ? void 0 : (_currentData$data$typ = _currentData$data.typography) === null || _currentData$data$typ === void 0 ? void 0 : _currentData$data$typ.slug) !== '') {
      var _currentData$data2, _currentData$data2$ty;

      handleClick(currentData === null || currentData === void 0 ? void 0 : (_currentData$data2 = currentData.data) === null || _currentData$data2 === void 0 ? void 0 : (_currentData$data2$ty = _currentData$data2.typography) === null || _currentData$data2$ty === void 0 ? void 0 : _currentData$data2$ty.slug, storedPreviewSettings, fontPalettes === null || fontPalettes === void 0 ? void 0 : fontPalettes.body);
    }
  ...
  const handleClick = async function (fontStyle) {
    ...
    let selectedGlobalStyle = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : storedPreviewSettings;
    let fontPalettesCopy = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : fontPalettes;
    ...
    globalStylesCopy.styles.blocks['core/heading'].typography.fontFamily = (_fontPalettesCopy$fon4 = fontPalettesCopy[fontStyle]) === null || _fontPalettesCopy$fon4 === void 0 ? void 0 : _fontPalettesCopy$fon4.styles.blocks['core/heading'].typography.fontFamily; // Saves the data to the Store

    currentData.data.typography.slug = fontStyle;
    currentData.data.typography.data = fontPalettesCopy[fontStyle];
    updatePreviewSettings((0,_utils_global_styles_use_global_styles_output__WEBPACK_IMPORTED_MODULE_6__.useGlobalStylesOutput)(globalStylesCopy, storedPreviewSettings));
    setCurrentOnboardingData(currentData);
    doRerender(1);
  };
  ...
  function buildPalettes() {
    ...
    for (const fontStyle in fontPalettes) {
      ...
      paletteRenderedList.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: `font-palette ${selectedFont == fontStyle ? 'font-palette-selected' : ''} `,
  ...
  function buildCustomPalette() {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-font-palette"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-font-palette__top",
      onClick: e => setIsAccordionClosed(!isAccordionClosed)
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-font-palette__top-text"
    }, "SELECT CUSTOM FONTS"), isAccordionClosed && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-font-palette__top-icon"
    }, "+"), !isAccordionClosed && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "custom-font-palette__top-icon"
    }, "-")));
  }

  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_LivePreview__WEBPACK_IMPORTED_MODULE_4__.GlobalStylesProvider, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ref: drawerFontOptions,
    className: "theme-fonts--drawer"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Font Palettes', 'wp-module-onboarding')), fontPalettes && buildPalettes(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "custom-font-palette--hidden"
  }, rerender)));
};

/* harmony default export */ __webpack_exports__["default"] = (DesignTypography);
...
/* harmony default export */ __webpack_exports__["default"] = (NavStoreInfo);
...
const NavDesign = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      key: step.path,
      className: "nfd-onboarding-drawer__panel-menu-item"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_9__.NavLink, {
      to: step.path,
...
/* harmony default export */ __webpack_exports__["default"] = (NavDesign);
...
/* harmony default export */ __webpack_exports__["default"] = (NavGetStarted);
...
/* harmony default export */ __webpack_exports__["default"] = (NavPage);
...
/* harmony default export */ __webpack_exports__["default"] = (NavPrimary);
...
/* harmony default export */ __webpack_exports__["default"] = (WithDesignBack);
...
const DrawerToggle = _ref => {
  ...
  const {
    ...
    return {
      isDrawerOpen: select(_store__WEBPACK_IMPORTED_MODULE_3__.store).isDrawerOpened(),
      isDrawerSuppressed: select(_store__WEBPACK_IMPORTED_MODULE_3__.store).isDrawerSuppressed()
    };
  }, []);
  const {
    setIsDrawerOpened
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__unstableMotion.div, {
    className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('nfd-onboarding-drawer__toggle', {
      'is-open': isDrawerOpen
    }),
    whileHover: "expand"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
    className: `nfd-onboarding-drawer__toggle-button has-icon ${!isDrawerSuppressed || 'is-suppressed'}`,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Toggle Navigation', 'wp-module-onboarding'),
    ref: drawerToggleRef,
    "aria-pressed": isOpen,
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _DrawerPanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DrawerPanel */ "./src/OnboardingSPA/components/Drawer/DrawerPanel/index.js");
/* harmony import */ var _DrawerToggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DrawerToggle */ "./src/OnboardingSPA/components/Drawer/DrawerToggle/index.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store */ "./src/OnboardingSPA/store/index.js");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @wordpress/compose */ "@wordpress/compose");
...
const Drawer = _ref => {
  ...
  const isDesktopViewport = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_5__.useViewportMatch)('medium');
  const {
    setIsDrawerOpened
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useDispatch)(_store__WEBPACK_IMPORTED_MODULE_3__.store);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_DrawerToggle__WEBPACK_IMPORTED_MODULE_2__["default"], null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_DrawerPanel__WEBPACK_IMPORTED_MODULE_1__["default"], null));
};
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/chevron-left.js");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__);
...
const ExitToWordPress = _ref => {
  let {
    text = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Exit to WordPress', 'wp-module-onboarding'),
    showIcon = true,
    showButton = true,
    variant = 'secondary',
    className = false,
  ...
  const label = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('You can restart onboarding from your Bluehost Settings page.', 'wp-module-onboarding');
  ...
  async function saveData(path, currentData) {
    ...
    const exitLink = exitToWordpressForEcommerce() ? _constants__WEBPACK_IMPORTED_MODULE_8__.bluehostDashboardPage : _constants__WEBPACK_IMPORTED_MODULE_8__.wpAdminPage;
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    icon: showIcon ? _wordpress_icons__WEBPACK_IMPORTED_MODULE_10__["default"] : false,
    variant: variant,
    onClick: openModal,
    className: classnames__WEBPACK_IMPORTED_MODULE_4___default()(`nfd-onboarding-etw__trigger`, className)
  }, text), isOpen && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Modal, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Exit without finishing?', 'wp-module-onboarding'),
    onRequestClose: closeModal
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, label), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ButtonGroup, {
    className: "nfd-onboarding-etw__buttons"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    variant: "secondary",
    onClick: closeModal
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Continue', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    variant: "primary",
    onClick: e => saveData(location.pathname, currentData)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Exit', 'wp-module-onboarding')))));
};
/*
...
/* harmony default export */ __webpack_exports__["default"] = (ExitToWordPress);

/***/ }),

/***/ "./src/OnboardingSPA/components/HeaderMenuPreview/index.js":
/*!*****************************************************************!*\
  !*** ./src/OnboardingSPA/components/HeaderMenuPreview/index.js ***!
  \*****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _LivePreview__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../LivePreview */ "./src/OnboardingSPA/components/LivePreview/index.js");





const HeaderMenuPreview = _ref => {
  let {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_LivePreview__WEBPACK_IMPORTED_MODULE_1__.LivePreview, {
    styling: styling,
...
/* harmony default export */ __webpack_exports__["default"] = (HeaderMenuPreview);
...
/* harmony default export */ __webpack_exports__["default"] = (HeaderEnd);
...
/* harmony import */ var _components_HeaderEnd__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/HeaderEnd */ "./src/OnboardingSPA/components/Header/components/HeaderEnd.js");
...
const Header = () => {
  ...
  const {
    ...
    return {
      firstStep: select(_store__WEBPACK_IMPORTED_MODULE_3__.store).getFirstStep()
    };
  }, []);
  const {
    previousStep,
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_HeaderEnd__WEBPACK_IMPORTED_MODULE_5__["default"], null)));
};
...
async function saveDataAndExit(currentData) {
  ...
  const exitLink = exitToWordpressForEcommerce() ? _constants__WEBPACK_IMPORTED_MODULE_6__.bluehostDashboardPage : _constants__WEBPACK_IMPORTED_MODULE_6__.wpAdminPage;
  window.location.replace(exitLink);
}
/**
...
/* harmony default export */ __webpack_exports__["default"] = (StepNavigation);
...
function AutoBlockPreview(_ref) {
  var _settings$__experimen, _settings$__experimen2, _duotone$default, _duotone$theme;
  ...
  }] = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.useResizeObserver)();
  ...
  const svgFilters = [...((_duotone$default = duotone === null || duotone === void 0 ? void 0 : duotone.default) !== null && _duotone$default !== void 0 ? _duotone$default : []), ...((_duotone$theme = duotone === null || duotone === void 0 ? void 0 : duotone.theme) !== null && _duotone$theme !== void 0 ? _duotone$theme : [])]; // Initialize on render instead of module top level, to avoid circular dependency issues.

  MemoizedBlockList = MemoizedBlockList || (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.pure)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.BlockList);
  const scale = containerWidth / viewportWidth;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "block-editor-block-preview__container"
  }, containerResizeListener, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Disabled, {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.__unstableIframe, {
    ...
    assets: assets,
    contentRef: (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.useRefEffect)(bodyElement => {
      const {
        ownerDocument: {
          documentElement
        }
  ...
  svgFilters.map(preset => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.__unstablePresetDuotoneFilter, {
    preset: preset,
    key: preset.slug
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(MemoizedBlockList, {
    renderAppender: false
  }))));
}

/* harmony default export */ __webpack_exports__["default"] = (AutoBlockPreview);
...
const BlockPreview = _ref => {
  ...
  const storedPreviewSettings = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => select(_store__WEBPACK_IMPORTED_MODULE_6__.store).getPreviewSettings(), []);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (previewSettings) {
      setSettings((0,_utils_global_styles_use_global_styles_output__WEBPACK_IMPORTED_MODULE_5__.useGlobalStylesOutput)(previewSettings, storedPreviewSettings));
    } else {
  ...
  })), settings && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockEditorProvider, {
    value: blocks,
...
const GlobalStylesProvider = _ref => {
  ...
  const getStylesAndPatterns = async () => {
    ...
    let selectedGlobalStyle;
    if (storedPreviewSettings !== null && storedPreviewSettings !== void 0 && storedPreviewSettings.title && storedPreviewSettings !== null && storedPreviewSettings !== void 0 && storedPreviewSettings.settings) selectedGlobalStyle = storedPreviewSettings;else if (currentData.data.theme.variation) {
      selectedGlobalStyle = globalStyles.body.filter(globalStyle => globalStyle.title === currentData.data.theme.variation)[0];
    } else if (((_globalStyles$body$ = globalStyles.body[0]) === null || _globalStyles$body$ === void 0 ? void 0 : _globalStyles$body$.id) === 0) {
      selectedGlobalStyle = globalStyles.body[0];
    }
    if (selectedGlobalStyle) (0,_utils_api_themes__WEBPACK_IMPORTED_MODULE_3__.setGlobalStyles)({ ...selectedGlobalStyle,
      title: currentData.data.theme.variation,
      version: 2
    });
    updatePreviewSettings((0,_utils_global_styles_use_global_styles_output__WEBPACK_IMPORTED_MODULE_4__.useGlobalStylesOutput)(selectedGlobalStyle, storedPreviewSettings));
    setIsLoaded(true);
  };
...
/* harmony default export */ __webpack_exports__["default"] = (GlobalStylesProvider);
...
const LivePreviewSkeleton = _ref => {
  ...
  const buildDummyPreviews = () => {
    ...
    for (let i = 0; i < count; i++) {
      dummyPreviews.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(___WEBPACK_IMPORTED_MODULE_1__.LivePreviewSelectableCard, {
        key: i,
        blockGrammer: '',
        styling: 'custom',
        className: className,
  ...
  const buildDummyPreviewsWithInfo = () => {
    ...
    for (let i = 0; i < count; i++) {
      dummyPreviews.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(___WEBPACK_IMPORTED_MODULE_1__.LivePreviewSelectableCardWithInfo, {
        key: i,
        className: className,
        blockGrammer: '',
        viewportWidth: 1200,
  ...
  return !watch ? isWithCard ? buildDummyPreviewsWithInfo() : buildDummyPreviews() : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, watch ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: 'none'
    }
...
/* harmony default export */ __webpack_exports__["default"] = (LivePreviewSkeleton);
...
const SelectableCardWithInfo = _ref => {
  ...
  })))), showDescription && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony default export */ __webpack_exports__["default"] = (SelectableCardWithInfo);
...
const SelectableCard = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    setIsLoadingParent: setIsLoadingParent,
    skeletonLoadingTime: skeletonLoadingTime
  }), overlay && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GlobalStylesProvider": function() { return /* reexport safe */ _GlobalStylesProvider__WEBPACK_IMPORTED_MODULE_4__["default"]; },
/* harmony export */   "LivePreview": function() { return /* reexport safe */ _BlockPreview__WEBPACK_IMPORTED_MODULE_0__["default"]; },
/* harmony export */   "LivePreviewSelectableCard": function() { return /* reexport safe */ _SelectableCard__WEBPACK_IMPORTED_MODULE_2__["default"]; },
/* harmony export */   "LivePreviewSelectableCardWithInfo": function() { return /* reexport safe */ _SelectableCardWithInfo__WEBPACK_IMPORTED_MODULE_3__["default"]; },
/* harmony export */   "LivePreviewSkeleton": function() { return /* reexport safe */ _LivePreviewSkeleton__WEBPACK_IMPORTED_MODULE_1__["default"]; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "conditionalSteps": function() { return /* binding */ conditionalSteps; },
/* harmony export */   "initialDesignSteps": function() { return /* binding */ initialDesignSteps; },
/* harmony export */   "initialGetStartedSteps": function() { return /* binding */ initialGetStartedSteps; },
/* harmony export */   "initialTopSteps": function() { return /* binding */ initialTopSteps; },
...
const StepDesignThemes = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() */ "src_OnboardingSPA_pages_Steps_DesignThemes_index_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../pages/Steps/DesignThemes */ "./src/OnboardingSPA/pages/Steps/DesignThemes/index.js")));
...
const steps = [{
  ...
  heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Make your %s dreams a reality!', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('website')),
  subheading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('with WordPress and ', 'wp-module-onboarding'),
  ...
  /* translators: %s: website or store */
  heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Help us tailor this setup to your %s', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('site')),
  subheading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('What is your experience with WordPress?', 'wp-module-onboarding'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("We'll use this to personalize this onboarding and future recommendations", 'wp-module-onboarding'),
  ...
  /* translators: %s: website or store */
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Primary %s Setup', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('Site')),

  /* translators: %s: website or store */
  heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Help us tailor this setup to your %s', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('site')),

  /* translators: %s: website or store */
  subheading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('What type of %s is it?', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('site')),

  /* translators: %s: website or store */
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Setup more of your %s, show you around WordPress or share secrets to success -- we'll follow your lead on how you'd like to proceed.", 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('site')),
  ...
  /* translators: %s: website or store */
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Secondary %s Setup', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('Site')),
  ...
  /* translators: %s: website or store */
  heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Introduce us to this %s', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('website')),
  subheading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('So we can introduce it to the web', 'wp-module-onboarding'),

  /* translators: %s: website or store */
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Help visitors, search results and social media identify your %s.', 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_4__.translations)('site')),
...
// },
{
  ...
  subheading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Use these styles or bring your own. You're always free to remix them.", 'wp-module-onboarding'),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ecommerceGetStartedSteps": function() { return /* binding */ ecommerceGetStartedSteps; },
/* harmony export */   "ecommerceSteps": function() { return /* binding */ ecommerceSteps; },
/* harmony export */   "initialTopSteps": function() { return /* binding */ initialTopSteps; },
/* harmony export */   "routes": function() { return /* binding */ routes; },
/* harmony export */   "steps": function() { return /* binding */ steps; }
/* harmony export */ });
...
/* harmony export */   "initialDesignSteps": function() { return /* binding */ initialDesignSteps; },
/* harmony export */   "initialGetStartedSteps": function() { return /* binding */ initialGetStartedSteps; },
/* harmony export */   "initialStoreInfoSteps": function() { return /* binding */ initialStoreInfoSteps; },
/* harmony export */   "initialTopSteps": function() { return /* binding */ initialTopSteps; },
/* harmony export */   "routes": function() { return /* binding */ routes; },
/* harmony export */   "steps": function() { return /* binding */ steps; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "sidebars": function() { return /* binding */ sidebars; }
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../constants */ "./src/constants.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "translationMap": function() { return /* binding */ translationMap; }
/* harmony export */ });
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initializeNFDOnboarding": function() { return /* binding */ initializeNFDOnboarding; }
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
async function initializeNFDOnboarding(id, runtime) {
  var _runtime$previewSetti, _runtime$previewSetti3;
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_10__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).updatePluginsStatus((_runtime$previewSetti3 = runtime.previewSettings.settings.preRequisites) === null || _runtime$previewSetti3 === void 0 ? void 0 : _runtime$previewSetti3.plugins);
...
/* harmony default export */ __webpack_exports__["default"] = (initializeNFDOnboarding);
...
/* harmony export */   "setActiveStep": function() { return /* binding */ setActiveStep; },
/* harmony export */   "setCurrentOnboardingData": function() { return /* binding */ setCurrentOnboardingData; },
/* harmony export */   "setDrawerActiveView": function() { return /* binding */ setDrawerActiveView; },
/* harmony export */   "setHeaderMenuData": function() { return /* binding */ setHeaderMenuData; },
/* harmony export */   "setIsDrawerOpened": function() { return /* binding */ setIsDrawerOpened; },
/* harmony export */   "setIsDrawerSuppressed": function() { return /* binding */ setIsDrawerSuppressed; },
/* harmony export */   "setIsHeaderNavigationEnabled": function() { return /* binding */ setIsHeaderNavigationEnabled; },
/* harmony export */   "setIsSidebarOpened": function() { return /* binding */ setIsSidebarOpened; },
/* harmony export */   "setRuntime": function() { return /* binding */ setRuntime; },
/* harmony export */   "setSidebarActiveView": function() { return /* binding */ setSidebarActiveView; },
/* harmony export */   "updateAllSteps": function() { return /* binding */ updateAllSteps; },
/* harmony export */   "updateDesignSteps": function() { return /* binding */ updateDesignSteps; },
/* harmony export */   "updatePluginsStatus": function() { return /* binding */ updatePluginsStatus; },
/* harmony export */   "updatePreviewSettings": function() { return /* binding */ updatePreviewSettings; },
/* harmony export */   "updateRoutes": function() { return /* binding */ updateRoutes; },
/* harmony export */   "updateSettings": function() { return /* binding */ updateSettings; },
/* harmony export */   "updateThemeStatus": function() { return /* binding */ updateThemeStatus; }
/* harmony export */ });
/**
...
function setCurrentOnboardingData(currentData) {
  return {
...
function updatePluginsStatus(pluginsStatus) {
  return {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "nfdOnboardingStoreConfig": function() { return /* binding */ nfdOnboardingStoreConfig; },
/* harmony export */   "store": function() { return /* binding */ store; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "currentData": function() { return /* binding */ currentData; },
...
function settings() {
  let state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    ...
    pluginsStatus: {
      [_constants__WEBPACK_IMPORTED_MODULE_1__.ECOMMERCE_STEPS_PLUGIN]: _constants__WEBPACK_IMPORTED_MODULE_1__.PLUGIN_STATUS_INIT
    }
  };
  let action = arguments.length > 1 ? arguments[1] : undefined;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getAllSteps": function() { return /* binding */ getAllSteps; },
/* harmony export */   "getCurrentOnboardingData": function() { return /* binding */ getCurrentOnboardingData; },
/* harmony export */   "getCurrentStep": function() { return /* binding */ getCurrentStep; },
/* harmony export */   "getCurrentStepPath": function() { return /* binding */ getCurrentStepPath; },
/* harmony export */   "getDesignSteps": function() { return /* binding */ getDesignSteps; },
/* harmony export */   "getDrawerView": function() { return /* binding */ getDrawerView; },
/* harmony export */   "getExpertsUrl": function() { return /* binding */ getExpertsUrl; },
/* harmony export */   "getFirstStep": function() { return /* binding */ getFirstStep; },
/* harmony export */   "getGetStartedSteps": function() { return /* binding */ getGetStartedSteps; },
/* harmony export */   "getHeaderMenuData": function() { return /* binding */ getHeaderMenuData; },
/* harmony export */   "getHireExpertsUrl": function() { return /* binding */ getHireExpertsUrl; },
/* harmony export */   "getLastStep": function() { return /* binding */ getLastStep; },
/* harmony export */   "getNewfoldBrand": function() { return /* binding */ getNewfoldBrand; },
/* harmony export */   "getNewfoldBrandName": function() { return /* binding */ getNewfoldBrandName; },
/* harmony export */   "getNextStep": function() { return /* binding */ getNextStep; },
/* harmony export */   "getOnboardingFlow": function() { return /* binding */ getOnboardingFlow; },
/* harmony export */   "getPluginInstallHash": function() { return /* binding */ getPluginInstallHash; },
/* harmony export */   "getPluginsStatus": function() { return /* binding */ getPluginsStatus; },
/* harmony export */   "getPreviewSettings": function() { return /* binding */ getPreviewSettings; },
/* harmony export */   "getPreviousStep": function() { return /* binding */ getPreviousStep; },
/* harmony export */   "getRoutes": function() { return /* binding */ getRoutes; },
/* harmony export */   "getSettings": function() { return /* binding */ getSettings; },
/* harmony export */   "getSidebarView": function() { return /* binding */ getSidebarView; },
/* harmony export */   "getSidebars": function() { return /* binding */ getSidebars; },
/* harmony export */   "getStepFromPath": function() { return /* binding */ getStepFromPath; },
/* harmony export */   "getStepPreviewData": function() { return /* binding */ getStepPreviewData; },
/* harmony export */   "getStoreInfoSteps": function() { return /* binding */ getStoreInfoSteps; },
/* harmony export */   "getTechSupportUrl": function() { return /* binding */ getTechSupportUrl; },
/* harmony export */   "getThemeStatus": function() { return /* binding */ getThemeStatus; },
/* harmony export */   "getTopSteps": function() { return /* binding */ getTopSteps; },
/* harmony export */   "getfullServiceCreativeTeamUrl": function() { return /* binding */ getfullServiceCreativeTeamUrl; },
/* harmony export */   "isDrawerOpened": function() { return /* binding */ isDrawerOpened; },
/* harmony export */   "isDrawerSuppressed": function() { return /* binding */ isDrawerSuppressed; },
/* harmony export */   "isHeaderNavigationEnabled": function() { return /* binding */ isHeaderNavigationEnabled; },
/* harmony export */   "isSidebarOpened": function() { return /* binding */ isSidebarOpened; }
/* harmony export */ });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
...
function getPluginsStatus(state) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "onboardingRestURL": function() { return /* binding */ onboardingRestURL; },
/* harmony export */   "wpRestURL": function() { return /* binding */ wpRestURL; }
/* harmony export */ });
...
/* harmony export */   "updateWPSettings": function() { return /* binding */ updateWPSettings; }
/* harmony export */ });
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "completeFlow": function() { return /* binding */ completeFlow; },
/* harmony export */   "getFlow": function() { return /* binding */ getFlow; },
/* harmony export */   "setFlow": function() { return /* binding */ setFlow; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getPluginStatus": function() { return /* binding */ getPluginStatus; },
/* harmony export */   "getSiteFeatures": function() { return /* binding */ getSiteFeatures; },
/* harmony export */   "init": function() { return /* binding */ init; },
/* harmony export */   "setSiteFeatures": function() { return /* binding */ setSiteFeatures; }
/* harmony export */ });
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common */ "./src/OnboardingSPA/utils/api/common.js");
...
const getPluginStatus = async plugin => {
  return await (0,_resolve__WEBPACK_IMPORTED_MODULE_3__.resolve)(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
    url: (0,_common__WEBPACK_IMPORTED_MODULE_1__.onboardingRestURL)('plugins/status' + (plugin ? `&plugin=${plugin}` : ''))
  }));
};
...
/* harmony export */   "getThemeFonts": function() { return /* binding */ getThemeFonts; },
/* harmony export */   "getThemeStatus": function() { return /* binding */ getThemeStatus; },
/* harmony export */   "init": function() { return /* binding */ init; },
/* harmony export */   "setGlobalStyles": function() { return /* binding */ setGlobalStyles; }
/* harmony export */ });
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common */ "./src/OnboardingSPA/utils/api/common.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getComputedFluidTypographyValue": function() { return /* binding */ getComputedFluidTypographyValue; },
/* harmony export */   "getTypographyFontSizeValue": function() { return /* binding */ getTypographyFontSizeValue; },
/* harmony export */   "getTypographyValueAndUnit": function() { return /* binding */ getTypographyValueAndUnit; },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getBlockSelectors": function() { return /* binding */ getBlockSelectors; },
/* harmony export */   "getLayoutStyles": function() { return /* binding */ getLayoutStyles; },
...
/* harmony export */   "getStylesDeclarations": function() { return /* binding */ getStylesDeclarations; },
...
/* harmony import */ var _wordpress_style_engine__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @wordpress/style-engine */ "./node_modules/@wordpress/style-engine/build-module/index.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ "./src/OnboardingSPA/utils/global-styles/utils.js");
...
function getStylesDeclarations() {
  ...
  const isRoot = _utils__WEBPACK_IMPORTED_MODULE_4__.ROOT_BLOCK_SELECTOR === selector;
  ...
  const extraRules = (0,_wordpress_style_engine__WEBPACK_IMPORTED_MODULE_5__.getCSSRules)(blockStyles);
...
function getLayoutStyles(_ref6) {
  ...
  let ruleset = '';
  let gapValue = hasBlockGapSupport ? (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.__experimentalGetGapCSSValue)(style === null || style === void 0 ? void 0 : (_style$spacing = style.spacing) === null || _style$spacing === void 0 ? void 0 : _style$spacing.blockGap) : ''; // Ensure a fallback gap value for the root layout definitions,
  // and use a fallback value if one is provided for the current block.

  if (hasFallbackGapSupport) {
    if (selector === _utils__WEBPACK_IMPORTED_MODULE_4__.ROOT_BLOCK_SELECTOR) {
  ...
  if (gapValue && tree !== null && tree !== void 0 && (_tree$settings = tree.settings) !== null && _tree$settings !== void 0 && (_tree$settings$layout = _tree$settings.layout) !== null && _tree$settings$layout !== void 0 && _tree$settings$layout.definitions) {
        ...
        spacingStyles.forEach(spacingStyle => {
          ...
          if (declarations.length) {
            ...
            if (!hasBlockGapSupport) {
              ...
              combinedSelector = selector === _utils__WEBPACK_IMPORTED_MODULE_4__.ROOT_BLOCK_SELECTOR ? `:where(.${className}${(spacingStyle === null || spacingStyle === void 0 ? void 0 : spacingStyle.selector) || ''})` : `:where(${selector}.${className}${(spacingStyle === null || spacingStyle === void 0 ? void 0 : spacingStyle.selector) || ''})`;
            } else {
              combinedSelector = selector === _utils__WEBPACK_IMPORTED_MODULE_4__.ROOT_BLOCK_SELECTOR ? `${selector} .${className}${(spacingStyle === null || spacingStyle === void 0 ? void 0 : spacingStyle.selector) || ''}` : `${selector}.${className}${(spacingStyle === null || spacingStyle === void 0 ? void 0 : spacingStyle.selector) || ''}`;
            }
    ...
    if (selector === _utils__WEBPACK_IMPORTED_MODULE_4__.ROOT_BLOCK_SELECTOR && hasBlockGapSupport) {
      ruleset += `${selector} { --wp--style--block-gap: ${gapValue}; }`;
    }
  } // Output base styles


  if (selector === _utils__WEBPACK_IMPORTED_MODULE_4__.ROOT_BLOCK_SELECTOR && tree !== null && tree !== void 0 && (_tree$settings2 = tree.settings) !== null && _tree$settings2 !== void 0 && (_tree$settings2$layou = _tree$settings2.layout) !== null && _tree$settings2$layou !== void 0 && _tree$settings2$layou.definitions) {
...
const getNodesWithSettings = (tree, blockSelectors) => {
  ...
  const pickPresets = treeToPickFrom => {
    const presets = {};
    _utils__WEBPACK_IMPORTED_MODULE_4__.PRESET_METADATA.forEach(_ref14 => {
      let {
        path
      } = _ref14;
...
const toStyles = function (tree, blockSelectors, hasBlockGapSupport, hasFallbackGapSupport) {
  ...
  nodesWithStyles.forEach(_ref17 => {
    ...
    if (!disableLayoutStyles && (_utils__WEBPACK_IMPORTED_MODULE_4__.ROOT_BLOCK_SELECTOR === selector || hasLayoutSupport)) {
...
const getBlockSelectors = blockTypes => {
  ...
  blockTypes.forEach(blockType => {
    ...
    Object.entries(BLOCK_SUPPORT_FEATURE_LEVEL_SELECTORS).forEach(_ref23 => {
      ...
      if (featureSelector) {
        featureSelectors[featureName] = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.scopeSelector)(selector, featureSelector);
      }
    });
    result[name] = {
      duotoneSelector,
...
/* harmony export */   "scopeSelector": function() { return /* binding */ scopeSelector; }
/* harmony export */ });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "findStepIndex": function() { return /* binding */ findStepIndex; },
/* harmony export */   "getQueryParam": function() { return /* binding */ getQueryParam; },
/* harmony export */   "insertAfterStep": function() { return /* binding */ insertAfterStep; },
/* harmony export */   "insertBeforeStep": function() { return /* binding */ insertBeforeStep; },
/* harmony export */   "insertStepAtIndex": function() { return /* binding */ insertStepAtIndex; }
/* harmony export */ });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);

const insertBeforeStep = (steps, path, newStep) => {};
const insertAfterStep = (steps, path, newStep) => {};
const insertStepAtIndex = (steps, index, newStep) => {};
const findStepIndex = (steps, path) => {
  const index = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.findIndex)(steps, {
    path
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DESIGN_STEPS_THEME": function() { return /* binding */ DESIGN_STEPS_THEME; },
/* harmony export */   "DRAWER_NAV_VIEWS": function() { return /* binding */ DRAWER_NAV_VIEWS; },
/* harmony export */   "DRAWER_VIEWS": function() { return /* binding */ DRAWER_VIEWS; },
/* harmony export */   "ECOMMERCE_STEPS_PLUGIN": function() { return /* binding */ ECOMMERCE_STEPS_PLUGIN; },
/* harmony export */   "MAX_RETRIES_SETTINGS_INIT": function() { return /* binding */ MAX_RETRIES_SETTINGS_INIT; },
/* harmony export */   "NFD_ONBOARDING_ELEMENT_ID": function() { return /* binding */ NFD_ONBOARDING_ELEMENT_ID; },
/* harmony export */   "NFD_ONBOARDING_EVENT_PREFIX": function() { return /* binding */ NFD_ONBOARDING_EVENT_PREFIX; },
/* harmony export */   "NFD_PLUGINS_QUERY_PARAM": function() { return /* binding */ NFD_PLUGINS_QUERY_PARAM; },
/* harmony export */   "NFD_THEMES_QUERY_PARAM": function() { return /* binding */ NFD_THEMES_QUERY_PARAM; },
/* harmony export */   "PLUGIN_INSTALL_WAIT_TIMEOUT": function() { return /* binding */ PLUGIN_INSTALL_WAIT_TIMEOUT; },
/* harmony export */   "PLUGIN_STATUS_ACTIVE": function() { return /* binding */ PLUGIN_STATUS_ACTIVE; },
/* harmony export */   "PLUGIN_STATUS_INIT": function() { return /* binding */ PLUGIN_STATUS_INIT; },
/* harmony export */   "PLUGIN_STATUS_INSTALLING": function() { return /* binding */ PLUGIN_STATUS_INSTALLING; },
/* harmony export */   "PLUGIN_STATUS_NOT_ACTIVE": function() { return /* binding */ PLUGIN_STATUS_NOT_ACTIVE; },
/* harmony export */   "SIDEBAR_LEARN_MORE": function() { return /* binding */ SIDEBAR_LEARN_MORE; },
/* harmony export */   "SIDEBAR_MENU_SLOTFILL_PREFIX": function() { return /* binding */ SIDEBAR_MENU_SLOTFILL_PREFIX; },
/* harmony export */   "SIDEBAR_SLOTFILL_PREFIX": function() { return /* binding */ SIDEBAR_SLOTFILL_PREFIX; },
/* harmony export */   "THEME_INSTALL_WAIT_TIMEOUT": function() { return /* binding */ THEME_INSTALL_WAIT_TIMEOUT; },
/* harmony export */   "THEME_STATUS_ACTIVE": function() { return /* binding */ THEME_STATUS_ACTIVE; },
/* harmony export */   "THEME_STATUS_INIT": function() { return /* binding */ THEME_STATUS_INIT; },
/* harmony export */   "THEME_STATUS_INSTALLING": function() { return /* binding */ THEME_STATUS_INSTALLING; },
/* harmony export */   "THEME_STATUS_NOT_ACTIVE": function() { return /* binding */ THEME_STATUS_NOT_ACTIVE; },
/* harmony export */   "VIEW_DESIGN_COLORS": function() { return /* binding */ VIEW_DESIGN_COLORS; },
/* harmony export */   "VIEW_DESIGN_HEADER_MENU": function() { return /* binding */ VIEW_DESIGN_HEADER_MENU; },
/* harmony export */   "VIEW_DESIGN_HOMEPAGE_MENU": function() { return /* binding */ VIEW_DESIGN_HOMEPAGE_MENU; },
/* harmony export */   "VIEW_DESIGN_THEMES": function() { return /* binding */ VIEW_DESIGN_THEMES; },
/* harmony export */   "VIEW_DESIGN_THEME_STYLES_MENU": function() { return /* binding */ VIEW_DESIGN_THEME_STYLES_MENU; },
/* harmony export */   "VIEW_DESIGN_THEME_STYLES_PREVIEW": function() { return /* binding */ VIEW_DESIGN_THEME_STYLES_PREVIEW; },
/* harmony export */   "VIEW_DESIGN_TYPOGRAPHY": function() { return /* binding */ VIEW_DESIGN_TYPOGRAPHY; },
/* harmony export */   "VIEW_NAV_DESIGN": function() { return /* binding */ VIEW_NAV_DESIGN; },
/* harmony export */   "VIEW_NAV_ECOMMERCE_STORE_INFO": function() { return /* binding */ VIEW_NAV_ECOMMERCE_STORE_INFO; },
/* harmony export */   "VIEW_NAV_GET_STARTED": function() { return /* binding */ VIEW_NAV_GET_STARTED; },
/* harmony export */   "VIEW_NAV_PAGE": function() { return /* binding */ VIEW_NAV_PAGE; },
/* harmony export */   "VIEW_NAV_PRIMARY": function() { return /* binding */ VIEW_NAV_PRIMARY; },
/* harmony export */   "bluehostDashboardPage": function() { return /* binding */ bluehostDashboardPage; },
/* harmony export */   "onboardingRestBase": function() { return /* binding */ onboardingRestBase; },
/* harmony export */   "onboardingRestRoute": function() { return /* binding */ onboardingRestRoute; },
/* harmony export */   "runtimeDataExists": function() { return /* binding */ runtimeDataExists; },
/* harmony export */   "wpAdminPage": function() { return /* binding */ wpAdminPage; },
/* harmony export */   "wpAdminUrl": function() { return /* binding */ wpAdminUrl; },
/* harmony export */   "wpRestBase": function() { return /* binding */ wpRestBase; },
/* harmony export */   "wpRestRoute": function() { return /* binding */ wpRestRoute; },
/* harmony export */   "wpRestURL": function() { return /* binding */ wpRestURL; },
/* harmony export */   "wpSiteUrl": function() { return /* binding */ wpSiteUrl; }
/* harmony export */ });
var _window;
...
const bluehostDashboardPage = `${wpAdminPage}?page=bluehost`;
...
const ECOMMERCE_STEPS_PLUGIN = 'woocommerce';
const PLUGIN_STATUS_INIT = 'init';
const PLUGIN_STATUS_NOT_ACTIVE = 'inactive';
const PLUGIN_STATUS_INSTALLING = 'installing';
const PLUGIN_STATUS_ACTIVE = 'activated';
const PLUGIN_INSTALL_WAIT_TIMEOUT = 30000;
/**
...
/* harmony default export */ __webpack_exports__["default"] = (webpackPublicPath);

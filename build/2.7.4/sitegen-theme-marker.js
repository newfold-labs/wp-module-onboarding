...
window.onload = function () {
  ...
  Object.keys(homepages).forEach(slug => {
    ...
    if (ele) {
      ele.innerHTML = (activeTheme === slug ? '<span>Active:</span>' : '') + `<svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
((window.newfold = window.newfold || {}).Onboarding = window.newfold.Onboarding || {})["sitegen-theme-marker"] = __webpack_exports__;
/******/ })()
;
//# sourceMappingURL=sitegen-theme-marker.js.map
...
const StepPrimarySetup = () => {
  var _currentData$data, _currentData$data$sit;
  ...
  const selectedPrimaryCategoryInStore = currentData === null || currentData === void 0 ? void 0 : (_currentData$data = currentData.data) === null || _currentData$data === void 0 ? void 0 : (_currentData$data$sit = _currentData$data.siteType) === null || _currentData$data$sit === void 0 ? void 0 : _currentData$data$sit.primary;
  ...
  if (selectedPrimaryCategoryInStore && !inputCategVal) {
    const found = categoriesArray.find(e => e.name === selectedPrimaryCategoryInStore);
    if (!found && selectedPrimaryCategoryInStore !== 'primaryCategory') changeInputCateg(selectedPrimaryCategoryInStore);
  }

  const handleCategoryClick = idxOfElm => {
    var _content$categories$i;

    changeCategory(idxOfElm);
    changeInputCateg('');
    const currentDataCopy = currentData;
    currentDataCopy.data.siteType.primary = (_content$categories$i = _content_json__WEBPACK_IMPORTED_MODULE_10__.categories[idxOfElm]) === null || _content$categories$i === void 0 ? void 0 : _content$categories$i.name;
  ...
  const categoryInput = input => {
    ...
    const currentDataCopy = currentData;
    currentDataCopy.data.siteType.primary = input === null || input === void 0 ? void 0 : (_input$target2 = input.target) === null || _input$target2 === void 0 ? void 0 : _input$target2.value;
    setCurrentOnboardingData(currentDataCopy);
  };

  const primarySiteTypeChips = () => {
    var _content$categories;

    let primaryChipList = [];
    let types = _content_json__WEBPACK_IMPORTED_MODULE_10__ === null || _content_json__WEBPACK_IMPORTED_MODULE_10__ === void 0 ? void 0 : (_content$categories = _content_json__WEBPACK_IMPORTED_MODULE_10__.categories) === null || _content$categories === void 0 ? void 0 : _content$categories.types;

    for (let typeKey in types) {
      var _types$typeKey, _types$typeKey2, _types$typeKey3;

      primaryChipList.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        key: (_types$typeKey = types[typeKey]) === null || _types$typeKey === void 0 ? void 0 : _types$typeKey.slug,
        className: `${types[typeKey].slug === selectedPrimaryCategoryInStore ? 'chosenPrimaryCategory ' : ''}nfd-card-category`,
        ...
        className: "icon",
        style: {
          backgroundImage: `url(${(_types$typeKey2 = types[typeKey]) === null || _types$typeKey2 === void 0 ? void 0 : _types$typeKey2.icon})`
        }
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "categName"
      }, (_types$typeKey3 = types[typeKey]) === null || _types$typeKey3 === void 0 ? void 0 : _types$typeKey3.label))));
    }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Layouts_Common__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    after: _content_json__WEBPACK_IMPORTED_MODULE_10__.categories && selectedPrimaryCategoryInStore !== null
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      backgroundColor: 'red'
    }
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("image", {
    src: "https://cdn.hiive.space/site-classification/business.svg",
    height: 24,
    width: 24
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "nfd-setup-primary-categories"
  }, primarySiteTypeChips()), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    disabled: _content_json__WEBPACK_IMPORTED_MODULE_10__.categories === null

...
const StepPrimarySetup = () => {
  ...
  const getSiteClassificationData = async () => {
    var _siteClassificationDa, _window, _window$nfdOnboarding, _currentData$data2, _currentData$data2$si, _currentData$data4, _currentData$data4$si, _currentData$data$sit3, _currentData$data6, _currentData$data6$si, _currentData$data6$si2, _currentData$data7, _currentData$data7$si, _currentData$data7$si2, _currentData$data11, _currentData$data11$s, _currentData$data11$s2;
    ...
    if (((_window = window) === null || _window === void 0 ? void 0 : (_window$nfdOnboarding = _window.nfdOnboarding) === null || _window$nfdOnboarding === void 0 ? void 0 : _window$nfdOnboarding.currentFlow) === 'ecommerce') {
      var _currentData$data, _currentData$data$sit, _currentData$data$sit2;

      primaryTypeList = ['business'];

      if ((currentData === null || currentData === void 0 ? void 0 : (_currentData$data = currentData.data) === null || _currentData$data === void 0 ? void 0 : (_currentData$data$sit = _currentData$data.siteType) === null || _currentData$data$sit === void 0 ? void 0 : (_currentData$data$sit2 = _currentData$data$sit.primary) === null || _currentData$data$sit2 === void 0 ? void 0 : _currentData$data$sit2.value) !== 'business') {
      ...
      var _siteClassificationDa2;

      primaryTypeList = Object.keys(siteClassificationData === null || siteClassificationData === void 0 ? void 0 : (_siteClassificationDa2 = siteClassificationData.body) === null || _siteClassificationDa2 === void 0 ? void 0 : _siteClassificationDa2.types);
    }

    setPrimaryTypeList(primaryTypeList); // Incase old user comes again with data, we need to save it

    if (typeof (currentData === null || currentData === void 0 ? void 0 : (_currentData$data2 = currentData.data) === null || _currentData$data2 === void 0 ? void 0 : (_currentData$data2$si = _currentData$data2.siteType) === null || _currentData$data2$si === void 0 ? void 0 : _currentData$data2$si.primary) === 'string') {
      var _currentData$data3, _currentData$data3$si;
    ...
    if (typeof (currentData === null || currentData === void 0 ? void 0 : (_currentData$data4 = currentData.data) === null || _currentData$data4 === void 0 ? void 0 : (_currentData$data4$si = _currentData$data4.siteType) === null || _currentData$data4$si === void 0 ? void 0 : _currentData$data4$si.secondary) === 'string') {
      var _currentData$data5, _currentData$data5$si;

      const secondaryValue = currentData === null || currentData === void 0 ? void 0 : (_currentData$data5 = currentData.data) === null || _currentData$data5 === void 0 ? void 0 : (_currentData$data5$si = _currentData$data5.siteType) === null || _currentData$data5$si === void 0 ? void 0 : _currentData$data5$si.secondary;
    ...
    setSecondaryCategory((_currentData$data$sit3 = currentData === null || currentData === void 0 ? void 0 : (_currentData$data6 = currentData.data) === null || _currentData$data6 === void 0 ? void 0 : (_currentData$data6$si = _currentData$data6.siteType) === null || _currentData$data6$si === void 0 ? void 0 : (_currentData$data6$si2 = _currentData$data6$si.secondary) === null || _currentData$data6$si2 === void 0 ? void 0 : _currentData$data6$si2.value) !== null && _currentData$data$sit3 !== void 0 ? _currentData$data$sit3 : '');
    ...
    if ((currentData === null || currentData === void 0 ? void 0 : (_currentData$data7 = currentData.data) === null || _currentData$data7 === void 0 ? void 0 : (_currentData$data7$si = _currentData$data7.siteType) === null || _currentData$data7$si === void 0 ? void 0 : (_currentData$data7$si2 = _currentData$data7$si.primary) === null || _currentData$data7$si2 === void 0 ? void 0 : _currentData$data7$si2.value) !== '') {
      ...
      const isNotPrimaryCustom = (currentData === null || currentData === void 0 ? void 0 : (_currentData$data8 = currentData.data) === null || _currentData$data8 === void 0 ? void 0 : (_currentData$data8$si = _currentData$data8.siteType) === null || _currentData$data8$si === void 0 ? void 0 : (_currentData$data8$si2 = _currentData$data8$si.primary) === null || _currentData$data8$si2 === void 0 ? void 0 : _currentData$data8$si2.refers) !== 'custom';

      if (isNotPrimaryCustom) {
        var _currentData$data9, _currentData$data9$si, _currentData$data9$si2;

        setPrimaryCategory(currentData === null || currentData === void 0 ? void 0 : (_currentData$data9 = currentData.data) === null || _currentData$data9 === void 0 ? void 0 : (_currentData$data9$si = _currentData$data9.siteType) === null || _currentData$data9$si === void 0 ? void 0 : (_currentData$data9$si2 = _currentData$data9$si.primary) === null || _currentData$data9$si2 === void 0 ? void 0 : _currentData$data9$si2.value);
      } else {
        var _currentData$data10, _currentData$data10$s, _currentData$data10$s2;

        setPrimaryCategory(defaultPrimaryType);
        categoryInput(currentData === null || currentData === void 0 ? void 0 : (_currentData$data10 = currentData.data) === null || _currentData$data10 === void 0 ? void 0 : (_currentData$data10$s = _currentData$data10.siteType) === null || _currentData$data10$s === void 0 ? void 0 : (_currentData$data10$s2 = _currentData$data10$s.secondary) === null || _currentData$data10$s2 === void 0 ? void 0 : _currentData$data10$s2.value);
      }
    } // Primary is valid and secondary is custom


    if ((currentData === null || currentData === void 0 ? void 0 : (_currentData$data11 = currentData.data) === null || _currentData$data11 === void 0 ? void 0 : (_currentData$data11$s = _currentData$data11.siteType) === null || _currentData$data11$s === void 0 ? void 0 : (_currentData$data11$s2 = _currentData$data11$s.secondary) === null || _currentData$data11$s2 === void 0 ? void 0 : _currentData$data11$s2.refers) === 'custom') {
      var _currentData$data12, _currentData$data12$s, _currentData$data12$s2;

      categoryInput(currentData === null || currentData === void 0 ? void 0 : (_currentData$data12 = currentData.data) === null || _currentData$data12 === void 0 ? void 0 : (_currentData$data12$s = _currentData$data12.siteType) === null || _currentData$data12$s === void 0 ? void 0 : (_currentData$data12$s2 = _currentData$data12$s.secondary) === null || _currentData$data12$s2 === void 0 ? void 0 : _currentData$data12$s2.value);
    }
  };
  /**
  ...
  const categoryInput = value => {
    ...
    if ('' !== secondaryCategory && secondaryCategory !== value) {
      ...
      setTypingTimeout(setTimeout(() => {
        (0,_utils_analytics__WEBPACK_IMPORTED_MODULE_12__.trackHiiveEvent)('secondary-type', {
          refers: 'custom',
          value
        });
      }, 1000));
  ...
  const secondarySiteTypeChips = () => {
    ...
    return Object.keys(types).map((type, idx) => {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: "categName"
      }, (_types$type2 = types[type]) === null || _types$type2 === void 0 ? void 0 : _types$type2.label));
    });
  };

"use strict";
(globalThis["webpackChunknewfold_Onboarding"] = globalThis["webpackChunknewfold_Onboarding"] || []).push([["src_OnboardingSPA_pages_Steps_DesignHomepageMenu_index_js"],{
...
/* harmony import */ var _utils_analytics__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../utils/analytics */ "./src/OnboardingSPA/utils/analytics/index.js");
...
const StepDesignHomepageMenu = () => {
  ...
  async function getHomepagePatternsData() {
    const homepagePatternDataTemp = await (0,_utils_api_patterns__WEBPACK_IMPORTED_MODULE_2__.getPatterns)(currentStep.patternId);
  ...
  function saveDataForHomepage(idx) {
    ...
    setCurrentOnboardingData(currentData);
    (0,_utils_analytics__WEBPACK_IMPORTED_MODULE_9__.trackHiiveEvent)('homepage-layout', homepage);
  }

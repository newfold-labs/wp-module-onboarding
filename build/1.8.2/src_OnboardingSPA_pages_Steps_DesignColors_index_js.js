"use strict";
(globalThis["webpackChunknewfold_Onboarding"] = globalThis["webpackChunknewfold_Onboarding"] || []).push([["src_OnboardingSPA_pages_Steps_DesignColors_index_js"],{
...
const StepDesignColors = () => {
  ...
  const getStylesAndPatterns = async () => {
    const patternResponse = await (0,_utils_api_patterns__WEBPACK_IMPORTED_MODULE_2__.getPatterns)(currentStep.patternId, true);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (_constants__WEBPACK_IMPORTED_MODULE_7__.THEME_STATUS_ACTIVE === themeStatus) getStylesAndPatterns();
  }, [themeStatus]);

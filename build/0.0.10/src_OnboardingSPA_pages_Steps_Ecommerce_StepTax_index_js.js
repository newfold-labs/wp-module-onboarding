...
const StepTax = () => {
  ...
  const settings = (0,_useWPSettings__WEBPACK_IMPORTED_MODULE_12__.useWPSettings)();
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (settings !== null && currentData.storeDetails.tax === undefined) {
      var _selectedTaxOption$da, _currentData$storeDet;

      let selectedTaxOption = _content_json__WEBPACK_IMPORTED_MODULE_11__.stepTaxOptions.find(createReverseLookup(settings));
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Layouts_Common__WEBPACK_IMPORTED_MODULE_7__["default"], {
    isBgPrimary: true,
    isCentered: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_NewfoldLargeCard__WEBPACK_IMPORTED_MODULE_9__["default"], null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(_content_json__WEBPACK_IMPORTED_MODULE_11__.stepTaxHeading, 'wp-module-onboarding'),
    subHeading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(_content_json__WEBPACK_IMPORTED_MODULE_11__.stepTaxSubHeading, 'wp-module-onboarding'),
    question: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)(_content_json__WEBPACK_IMPORTED_MODULE_11__.question, 'wp-module-onboarding')
  }), settings === null && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Loading...")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.RadioControl, {
    ...
    options: _content_json__WEBPACK_IMPORTED_MODULE_11__.stepTaxOptions.map(option => {
      return {
    ...
    onChange: value => {
      let selectedOption = _content_json__WEBPACK_IMPORTED_MODULE_11__.stepTaxOptions.find(option => option.value === value);
      setCurrentOnboardingData({
        storeDetails: { ...currentData.storeDetails,

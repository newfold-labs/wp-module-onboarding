...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _Loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Loader */ "./src/OnboardingSPA/components/Loader/index.js");
...
const ImageUploader = _ref => {
  ...
  function loader() {
    ...
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Loader__WEBPACK_IMPORTED_MODULE_2__["default"], null));
  }
...
/***/ "./src/OnboardingSPA/components/Loader/index.js":
/*!******************************************************!*\
  !*** ./src/OnboardingSPA/components/Loader/index.js ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const MiniPreview = _ref => {
  ...
  var titlePreview = title == "" ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_miniPreview_json__WEBPACK_IMPORTED_MODULE_2__.title, 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_3__.translations)('Site')) : title === null || title === void 0 ? void 0 : title.substring(0, 20);
  ...
  function socialIconList() {
    ...
    socialDataset.map(socialInfo => {
      !socialInfo.url || socialIconList.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        key: socialInfo.image,
        className: `browser-content_social_icon ${isValidUrl(socialInfo.url) || 'invalid-url'}`,
        style: {
...
const SocialMediaForm = _ref => {
  ...
  const checkValidUrl = function (socialInput, data) {
    if (!isValidUrl(data)) {
      if (!activeError.includes(socialInput)) setActiveError([...activeError, socialInput]);
    } else {
    ...
    if (activeError.length == 0) setIsValidSocials(true);else setIsValidSocials(false);
  };
  ...
  function buildSocialBoxes() {
    ...
    for (var social in SocialMediaSites) {
      socialBoxes.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        content: activeError.includes(SocialMediaSites[social]) ? `Please enter a valid ${SocialMediaSites[social]} URL` : 'hide',
        direction: "top"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: `social-form__top-row_icon ${isActive ? 'social-form__top-row_icon_opened' : ''}`
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    className: isActive ? 'social-form__main-active' : 'social-form__main-hidden',
    onSubmit: e => {
      handleSubmit(e);
    }
  }, buildSocialBoxes()));
...
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _content_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./content.json */ "./src/OnboardingSPA/pages/Steps/BasicInfo/content.json");
...
/* harmony import */ var _components_ImageUploader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/ImageUploader */ "./src/OnboardingSPA/components/ImageUploader/index.js");
/* harmony import */ var _components_SocialMediaForm__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../components/SocialMediaForm */ "./src/OnboardingSPA/components/SocialMediaForm/index.js");
...
const BasicInfoForm = () => {
  ...
  const {
    ...
    return {
      currentData: select(_store__WEBPACK_IMPORTED_MODULE_8__.store).getCurrentOnboardingData()
    };
  }, []);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    async function getFlowData() {
      const socialDataAPI = await (0,_utils_api_settings__WEBPACK_IMPORTED_MODULE_7__.getSettings)();
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.error.title, 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteTitle.title, 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_11__.translations)('Site')),
    hint: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteTitle.hint, 'wp-module-onboarding'),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteTitle.placeholder, 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_11__.translations)('Site')),
    maxCharacters: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteTitle.maxCharacters, 'wp-module-onboarding'),
    height: "47px",
    textValue: siteTitle,
    textValueSetter: setSiteTitle
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_TextInput__WEBPACK_IMPORTED_MODULE_4__["default"], {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteDesc.title, 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_11__.translations)('Site')),
    hint: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteDesc.hint, 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_11__.translations)('site')),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteDesc.placeholder, 'wp-module-onboarding'), (0,_utils_locales_translations__WEBPACK_IMPORTED_MODULE_11__.translations)('Site')),
    maxCharacters: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(_content_json__WEBPACK_IMPORTED_MODULE_3__.siteDesc.maxCharacters, 'wp-module-onboarding'),
    height: "100px",
    textValue: siteDesc,
    textValueSetter: setSiteDesc
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_SocialMediaForm__WEBPACK_IMPORTED_MODULE_10__["default"], {
    socialData: socialData,
    setSocialData: setSocialData,
    setIsValidSocials: setIsValidSocials
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "basic-info-form__right"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_ImageUploader__WEBPACK_IMPORTED_MODULE_9__["default"], {
    icon: siteLogo,
...
async function uploadImage(file) {
  ...
  return await (0,_resolve__WEBPACK_IMPORTED_MODULE_0__.resolve)(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()({
    url: `${_constants__WEBPACK_IMPORTED_MODULE_1__.wpRestBase}/wp/v2/media`,
    method: 'POST',
    headers,
    body: data
  }));

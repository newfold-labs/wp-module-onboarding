"use strict";
(self["webpackChunknewfold_Onboarding"] = self["webpackChunknewfold_Onboarding"] || []).push([["src_OnboardingSPA_pages_Steps_GetStarted_SiteTypeSetup_PrimarySite_index_js"],{
...
const StepPrimarySetup = () => {
  ...
  }, _content_json__WEBPACK_IMPORTED_MODULE_10__.categories.map((item, idx) => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "icon",
      style: {
        backgroundImage: clickedIndex !== idx && item.name !== selectedPrimaryCategoryInStore ? item === null || item === void 0 ? void 0 : item.icon : item === null || item === void 0 ? void 0 : item.iconWhite
      }
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "categName"

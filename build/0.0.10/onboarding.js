...
/* harmony import */ var _components_LivePreview__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../components/LivePreview */ "./src/OnboardingSPA/components/LivePreview/index.js");
...
const DesignThemeStylesPreview = () => {
  ...
  const scrollRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  ...
  const {
    ...
    return {
      currentStep: select(_store__WEBPACK_IMPORTED_MODULE_1__.store).getCurrentStep(),
  ...
  const getStylesAndPatterns = async () => {
    const pattern = await (0,_utils_api_patterns__WEBPACK_IMPORTED_MODULE_4__.getPatterns)(currentStep.patternId, true);
    ...
    const previewSettings = globalStyles === null || globalStyles === void 0 ? void 0 : globalStyles.body.filter(globalStyle => {
      return globalStyle['title'] === currentData.data['theme']['variation'];
    })[0];
    console.log(previewSettings);
    const updatedPreviewSettings = (0,_utils_global_styles_use_global_styles_output__WEBPACK_IMPORTED_MODULE_6__.useGlobalStylesOutput)(previewSettings);
  ...
  const buildPreviews = () => {
    return globalStyles === null || globalStyles === void 0 ? void 0 : globalStyles.map((globalStyle, idx) => {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: "theme-styles-preview--drawer__list__item__title-bar"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "theme-styles-preview--drawer__list__title-bar__browser"
        ...
        className: `${globalStyles[idx]['title'] == selectedStyle ? 'theme-styles-preview--drawer__list__item__title-bar--selected' : 'theme-styles-preview--drawer__list__item__title-bar--unselected'}`
        ...
        className: "theme-styles-preview--drawer__list__item__live-preview-container"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_LivePreview__WEBPACK_IMPORTED_MODULE_3__["default"], {

"use strict";
(globalThis["webpackChunknewfold_Onboarding"] = globalThis["webpackChunknewfold_Onboarding"] || []).push([["src_OnboardingSPA_steps_WhatNext_index_js"],{
...
/***/ "./src/OnboardingSPA/steps/WhatNext/contents.js":
/*!******************************************************!*\
  !*** ./src/OnboardingSPA/steps/WhatNext/contents.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const getContents = (brandName, brandSlug) => {
  ...
  switch (brandSlug) {
    case 'hostgator-br':
      contents.tabs[2].title = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('ALWAYS COUNT ON OUR TEAM', 'wp-module-onboarding');
      contents.tabs[2].subtitle = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('24 hours a day / 7 days a week', 'wp-module-onboarding');
      contents.tabs[2].text = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('From beginner to advanced, you have a partner to trust. Our support works when you work. Also count on various help materials on YouTube, blog and Knowledge Base.', 'wp-module-onboarding');
...
/***/ "./src/OnboardingSPA/steps/WhatNext/index.js":
/*!***************************************************!*\
  !*** ./src/OnboardingSPA/steps/WhatNext/index.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _contents__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./contents */ "./src/OnboardingSPA/steps/WhatNext/contents.js");
...
const StepWhatNext = () => {
  ...
  const {
    ...
    return {
      ...
      brandSlug: select(_store__WEBPACK_IMPORTED_MODULE_8__.store).getNewfoldBrand()
    };
  });
  const content = (0,_contents__WEBPACK_IMPORTED_MODULE_10__["default"])(brandName, brandSlug);
...
//# sourceMappingURL=src_OnboardingSPA_steps_WhatNext_index_js.js.map
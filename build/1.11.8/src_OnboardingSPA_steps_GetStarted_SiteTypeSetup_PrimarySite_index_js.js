"use strict";
(globalThis["webpackChunknewfold_Onboarding"] = globalThis["webpackChunknewfold_Onboarding"] || []).push([["src_OnboardingSPA_steps_GetStarted_SiteTypeSetup_PrimarySite_index_js"],{
...
/***/ "./src/OnboardingSPA/steps/GetStarted/SiteTypeSetup/PrimarySite/index.js":
/*!*******************************************************************************!*\
  !*** ./src/OnboardingSPA/steps/GetStarted/SiteTypeSetup/PrimarySite/index.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const StepPrimarySetup = () => {
  ...
  const handleCategoryClick = primType => {
    ...
    setCurrentOnboardingData(currentData);
    (0,_utils_analytics_hiive__WEBPACK_IMPORTED_MODULE_12__.trackOnboardingEvent)(new _utils_analytics_hiive__WEBPACK_IMPORTED_MODULE_12__.OnboardingEvent(_utils_analytics_hiive_constants__WEBPACK_IMPORTED_MODULE_13__.ACTION_PRIMARY_TYPE_SET, primType));
  };
  /**
  ...
  const categoryInput = value => {
    ...
    if ('' !== primaryCategory && primaryCategory !== value) {
      ...
      setTypingTimeout(setTimeout(() => {
        (0,_utils_analytics_hiive__WEBPACK_IMPORTED_MODULE_12__.trackOnboardingEvent)(new _utils_analytics_hiive__WEBPACK_IMPORTED_MODULE_12__.OnboardingEvent(_utils_analytics_hiive_constants__WEBPACK_IMPORTED_MODULE_13__.ACTION_PRIMARY_TYPE_SET, value));
      }, 1000));
    }
  ...
  const primarySiteTypeChips = () => {
    ...
    return Object.keys(types).map((type, idx) => {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        style: {
          backgroundImage: `url(${(_types$type3 = types[type]) === null || _types$type3 === void 0 ? void 0 : _types$type3.icon})`
        }
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "categName"
      }, (_types$type4 = types[type]) === null || _types$type4 === void 0 ? void 0 : _types$type4.label)));
    });
  };
...
//# sourceMappingURL=src_OnboardingSPA_steps_GetStarted_SiteTypeSetup_PrimarySite_index_js.js.map
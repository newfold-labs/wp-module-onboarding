...
const DesignColors = () => {
  ...
  function stateToLocal(selectedColors) {
    if (selectedColors) {
      ...
      selectedColors === null || selectedColors === void 0 ? void 0 : selectedColors.color.forEach(color => {
  ...
  function LocalToState(selectedColorsLocalTemp, colorStyle) {
    if (selectedColorsLocalTemp && colorStyle) {
      ...
      selectedColorsTemp.name = (colorStyle === null || colorStyle === void 0 ? void 0 : colorStyle.charAt(0).toUpperCase()) + (colorStyle === null || colorStyle === void 0 ? void 0 : colorStyle.slice(1));
      let colorsArray = [];
    ...
    if (colorStyle && selectedThemeColorPalette) {
      for (let idx = 0; idx < selectedThemeColorPalette.length; idx++) {
        switch ((_selectedThemeColorPa = selectedThemeColorPalette[idx]) === null || _selectedThemeColorPa === void 0 ? void 0 : _selectedThemeColorPa.slug) {
          ...
          case 'background':
            if (isCustomStyle && (selectedColorsLocalTemp === null || selectedColorsLocalTemp === void 0 ? void 0 : selectedColorsLocalTemp.background) != '') selectedThemeColorPalette[idx].color = selectedColorsLocalTemp.background;else if (!isCustomStyle) selectedThemeColorPalette[idx].color = '#ffffff';
            break;
        }
      }
  ...
  async function saveCustomColors() {
    var _selectedGlobalStyle$4, _selectedGlobalStyle$5, _selectedGlobalStyle$6, _selectedThemeColorPa2;

    let selectedGlobalStyle = globalStyles;
    let selectedThemeColorPalette = selectedGlobalStyle === null || selectedGlobalStyle === void 0 ? void 0 : (_selectedGlobalStyle$4 = selectedGlobalStyle.settings) === null || _selectedGlobalStyle$4 === void 0 ? void 0 : (_selectedGlobalStyle$5 = _selectedGlobalStyle$4.color) === null || _selectedGlobalStyle$5 === void 0 ? void 0 : (_selectedGlobalStyle$6 = _selectedGlobalStyle$5.palette) === null || _selectedGlobalStyle$6 === void 0 ? void 0 : _selectedGlobalStyle$6.theme;

    if (selectedThemeColorPalette) {
      for (let idx = 0; idx < selectedThemeColorPalette.length; idx++) {
        switch ((_selectedThemeColorPa2 = selectedThemeColorPalette[idx]) === null || _selectedThemeColorPa2 === void 0 ? void 0 : _selectedThemeColorPa2.slug) {
          case 'background':
  ...
  const getColorStylesAndPatterns = async () => {
    ...
    if (!(currentData !== null && currentData !== void 0 && (_currentData$data2 = currentData.data) !== null && _currentData$data2 !== void 0 && (_currentData$data2$pa = _currentData$data2.palette) !== null && _currentData$data2$pa !== void 0 && _currentData$data2$pa.slug) === '') {
  ...
  const handleClick = colorStyle => {
    ...
    for (let custom in customColorsTemp) customColorsTemp[custom] = '';
...
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _LivePreview__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../LivePreview */ "./src/OnboardingSPA/components/LivePreview/index.js");
...
const DesignThemeStylesPreview = () => {
  ...
  const getStylesAndPatterns = async () => {
    const patternResponse = await (0,_utils_api_patterns__WEBPACK_IMPORTED_MODULE_4__.getPatterns)(currentStep.patternId, true);
    ...
    const globalStylesResponse = await (0,_utils_api_themes__WEBPACK_IMPORTED_MODULE_5__.getGlobalStyles)();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!isLoaded && themeStatus === _constants__WEBPACK_IMPORTED_MODULE_7__.THEME_STATUS_ACTIVE) getStylesAndPatterns();
  ...
  const buildPreviews = () => {
    return globalStyles === null || globalStyles === void 0 ? void 0 : globalStyles.map((globalStyle, idx) => {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_LivePreview__WEBPACK_IMPORTED_MODULE_2__.LivePreviewSelectableCard, {
        key: idx,
...
const NavStoreInfo = () => {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Site Setup', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
const NavDesign = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_6__["default"],
    onClick: () => setDrawerActiveView(_constants__WEBPACK_IMPORTED_MODULE_3__.VIEW_NAV_PRIMARY)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Main Menu', 'wp-module-onboarding')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "nfd-onboarding-drawer__panel-menu"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "nfd-onboarding-drawer__panel-routes"
...
const NavPrimary = () => {
  ...
  const {
    ...
    return {
      topSteps: select(_store__WEBPACK_IMPORTED_MODULE_4__.store).getTopSteps()
    };
  }, []);
  const {
    setDrawerActiveView
...
const HeaderEnd = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_step_navigation__WEBPACK_IMPORTED_MODULE_3__["default"], null), sidebars.map(sidebar => {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/chevron-left.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/chevron-right.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__);
...
const Next = _ref2 => {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Next', 'wp-module-onboarding'), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_icons__WEBPACK_IMPORTED_MODULE_9__["default"], {
...
const Finish = _ref3 => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    ...
    variant: "primary"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Finish', 'wp-module-onboarding'), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_icons__WEBPACK_IMPORTED_MODULE_9__["default"], {
    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_11__["default"]
  }));
};
/**
...
/* harmony export */   "LivePreviewSelectableCard": function() { return /* reexport safe */ _SelectableCard__WEBPACK_IMPORTED_MODULE_1__["default"]; }
/* harmony export */ });
...
/* harmony import */ var _SelectableCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SelectableCard */ "./src/OnboardingSPA/components/LivePreview/SelectableCard/index.js");
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/header.js");
...
const StepIndex = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() */ "src_OnboardingSPA_pages_Steps_index_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../pages/Steps/index */ "./src/OnboardingSPA/pages/Steps/index.js")));
const StepGetStarted = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() */ "src_OnboardingSPA_pages_Steps_GetStarted_index_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../pages/Steps/GetStarted */ "./src/OnboardingSPA/pages/Steps/GetStarted/index.js")));
const StepWelcome = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() */ "src_OnboardingSPA_pages_Steps_GetStarted_Welcome_index_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../pages/Steps/GetStarted/Welcome */ "./src/OnboardingSPA/pages/Steps/GetStarted/Welcome/index.js")));
...
const StepPrimarySetup = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() */ "src_OnboardingSPA_pages_Steps_GetStarted_SiteTypeSetup_PrimarySite_index_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../pages/Steps/GetStarted/SiteTypeSetup/PrimarySite */ "./src/OnboardingSPA/pages/Steps/GetStarted/SiteTypeSetup/PrimarySite/index.js")));
const StepSecondarySetup = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() */ "src_OnboardingSPA_pages_Steps_GetStarted_SiteTypeSetup_SecondarySite_index_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../pages/Steps/GetStarted/SiteTypeSetup/SecondarySite */ "./src/OnboardingSPA/pages/Steps/GetStarted/SiteTypeSetup/SecondarySite/index.js")));
const GetStartedLearnMoreHelp = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() */ "src_OnboardingSPA_pages_Steps_GetStarted_SidebarComponents_LearnMore_Help_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../pages/Steps/GetStarted/SidebarComponents/LearnMore/Help */ "./src/OnboardingSPA/pages/Steps/GetStarted/SidebarComponents/LearnMore/Help.js")));
/**
...
const steps = [{
  ...
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Themes', 'wp-module-onboarding'),
  heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Let's make you look your best", 'wp-module-onboarding'),
  ...
  priority: 140,
  VIEW: _constants__WEBPACK_IMPORTED_MODULE_5__.VIEW_DESIGN_THEMES
}, {
  ...
  priority: 160,
  VIEW: _constants__WEBPACK_IMPORTED_MODULE_5__.VIEW_DESIGN_THEME_STYLES_MENU,
  ...
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('HomePages Wizard', 'wp-module-onboarding'),
  ...
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Pages', 'wp-module-onboarding'),
  heading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("We've got some page ideas", 'wp-module-onboarding'),
  ...
  subheading: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("We've learned a lot in 16 years of WordPress! Now that expertise is yours.", 'wp-module-onboarding'),
...
const initialTopSteps = () => {
  const topSteps = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.filter)(steps, step => {
    return !step.path.includes('/step/get-started') && !step.path.includes('/step/design');
  });
  const designStep = {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/box.js");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _utils_api_settings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/api/settings */ "./src/OnboardingSPA/utils/api/settings.js");
/* harmony import */ var _components_App__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/App */ "./src/OnboardingSPA/components/App/index.js");
...
const NFDOnboarding = () => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_10__.HashRouter, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_App__WEBPACK_IMPORTED_MODULE_8__["default"], null));
...
async function initializeNFDOnboarding(id, runtime) {
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).setRuntime(runtime);
  ...
  if (currentData.error == null) {
    ...
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_2__.store).setCurrentOnboardingData(currentData.body);
  }
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../constants */ "./src/constants.js");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./common */ "./src/OnboardingSPA/utils/api/common.js");
...
async function getFlow() {
  return await (0,_resolve__WEBPACK_IMPORTED_MODULE_0__.resolve)(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
    url: (0,_common__WEBPACK_IMPORTED_MODULE_2__.onboardingRestURL)('flow')
  }).then());
}
...
const getPreviewSettings = async () => {
  return await (0,_resolve_js__WEBPACK_IMPORTED_MODULE_1__.resolve)(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
    url: (0,_common__WEBPACK_IMPORTED_MODULE_3__.onboardingRestURL)('settings/preview')
  }));
};
...
/* harmony import */ var _wordpress_style_engine__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/style-engine */ "./node_modules/@wordpress/style-engine/build-module/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./src/OnboardingSPA/utils/global-styles/utils.js");
/**
 * External dependencies
 */
...
function compileStyleValue(uncompiledValue) {
  ...
  if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.startsWith)(uncompiledValue, VARIABLE_REFERENCE_PREFIX)) {
...
function getPresetsDeclarations() {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.reduce)(_utils__WEBPACK_IMPORTED_MODULE_2__.PRESET_METADATA, (declarations, _ref) => {
    let {
      path,
      valueKey,
      valueFunc,
    ...
    const presetByOrigin = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(blockPresets, path, []);
    ['default', 'theme', 'custom'].forEach(origin => {
      if (presetByOrigin[origin]) {
        presetByOrigin[origin].forEach(value => {
          if (valueKey) {
            declarations.push(`--wp--preset--${cssVarInfix}--${(0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(value.slug)}: ${value[valueKey]}`);
          } else if (valueFunc && typeof valueFunc === 'function') {
            declarations.push(`--wp--preset--${cssVarInfix}--${(0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(value.slug)}: ${valueFunc(value)}`);
          }
        });
      }
    });
...
function getPresetsClasses(blockSelector) {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.reduce)(_utils__WEBPACK_IMPORTED_MODULE_2__.PRESET_METADATA, (declarations, _ref2) => {
    let {
      path,
      cssVarInfix,
      classes
      ...
      if (presetByOrigin[origin]) {
        presetByOrigin[origin].forEach(_ref3 => {
          ...
          classes.forEach(_ref4 => {
            ...
            const classSelectorToUse = `.has-${(0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(slug)}-${classSuffix}`;
            const selectorToUse = blockSelector.split(',') // Selector can be "h1, h2, h3"
            .map(selector => `${selector}${classSelectorToUse}`).join(',');
            const value = `var(--wp--preset--${cssVarInfix}--${(0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(slug)})`;
...
function flattenTree() {
  ...
  Object.keys(input).forEach(key => {
    const newKey = prefix + (0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(key.replace('/', '-'));
...
function getStylesDeclarations() {
  ...
  const output = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.reduce)(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.__EXPERIMENTAL_STYLE_PROPERTY, (declarations, _ref5, key) => {
    let {
      value,
      properties,
      useEngine
    ...
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.first)(pathToValue) === 'elements' || useEngine) {
      return declarations;
    }

    const styleValue = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(blockStyles, pathToValue);

    if (!!properties && !(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isString)(styleValue)) {
      Object.entries(properties).forEach(entry => {
        const [name, prop] = entry;

        if (!(0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(styleValue, [prop], false)) {
          // Do not create a declaration
          // for sub-properties that don't have any value.
          return;
        }

        const cssProperty = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(name);
        declarations.push(`${cssProperty}: ${compileStyleValue((0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(styleValue, [prop]))}`);
      });
    } else if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(blockStyles, pathToValue, false)) {
      const cssProperty = key.startsWith('--') ? key : (0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(key);
      declarations.push(`${cssProperty}: ${compileStyleValue((0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(blockStyles, pathToValue))}`);
    }
  ...
  extraRules.forEach(rule => {
    const cssProperty = rule.key.startsWith('--') ? rule.key : (0,lodash__WEBPACK_IMPORTED_MODULE_0__.kebabCase)(rule.key);
...
const getNodesWithStyles = (tree, blockSelectors) => {
  ...
  const pickStyleKeys = treeToPickFrom => (0,lodash__WEBPACK_IMPORTED_MODULE_0__.pickBy)(treeToPickFrom, (value, key) => ['border', 'color', 'spacing', 'typography', 'filter'].includes(key)); // Top-level.
  ...
  if (!!styles) {
    nodes.push({
      styles,
      selector: _utils__WEBPACK_IMPORTED_MODULE_2__.ROOT_BLOCK_SELECTOR
    });
  }

  (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)((_tree$styles = tree.styles) === null || _tree$styles === void 0 ? void 0 : _tree$styles.elements, (value, key) => {
    if (!!value && !!_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.__EXPERIMENTAL_ELEMENTS[key]) {
      nodes.push({
        styles: value,
        selector: _wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.__EXPERIMENTAL_ELEMENTS[key]
      });
    }
  }); // Iterate over blocks: they can have styles & elements.

  (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)((_tree$styles2 = tree.styles) === null || _tree$styles2 === void 0 ? void 0 : _tree$styles2.blocks, (node, blockName) => {
    ...
    (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)(node === null || node === void 0 ? void 0 : node.elements, (value, elementName) => {
      if (!!value && !!(blockSelectors !== null && blockSelectors !== void 0 && blockSelectors[blockName]) && !!(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.__EXPERIMENTAL_ELEMENTS !== null && _wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.__EXPERIMENTAL_ELEMENTS !== void 0 && _wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.__EXPERIMENTAL_ELEMENTS[elementName])) {
        nodes.push({
          styles: value,
          selector: blockSelectors[blockName].selector.split(',').map(sel => {
            const elementSelectors = _wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.__EXPERIMENTAL_ELEMENTS[elementName].split(',');
...
const getNodesWithSettings = (tree, blockSelectors) => {
  ...
  const pickPresets = treeToPickFrom => {
    const presets = {};
    _utils__WEBPACK_IMPORTED_MODULE_2__.PRESET_METADATA.forEach(_ref6 => {
      let {
        path
      } = _ref6;
      const value = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(treeToPickFrom, path, false);

      if (value !== false) {
        (0,lodash__WEBPACK_IMPORTED_MODULE_0__.set)(presets, path, value);
      }
    });
    return presets;
  }; // Top-level.
  ...
  if (!(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(presets) || !!custom) {
    nodes.push({
      presets,
      custom,
      selector: _utils__WEBPACK_IMPORTED_MODULE_2__.ROOT_BLOCK_SELECTOR
  ...
  (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)((_tree$settings2 = tree.settings) === null || _tree$settings2 === void 0 ? void 0 : _tree$settings2.blocks, (node, blockName) => {
    const blockPresets = pickPresets(node);
    const blockCustom = node.custom;

    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(blockPresets) || !!blockCustom) {
      nodes.push({
...
const toStyles = (tree, blockSelectors, hasBlockGapSupport) => {
  ...
  nodesWithSettings.forEach(_ref11 => {
    ...
    if (_utils__WEBPACK_IMPORTED_MODULE_2__.ROOT_BLOCK_SELECTOR === selector) {
    ...
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(classes)) {
...
function useGlobalStylesOutput(previewSettings, storedPreviewSettings) {
  ...
  const blockSelectors = getBlockSelectors((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.getBlockTypes)());
  const customProperties = toCustomProperties(requiredSettings, blockSelectors);
  const globalStyles = toStyles(requiredSettings, blockSelectors, hasBlockGapSupport);
  const stylesheets = [...storedPreviewSettings.settings.styles, {
...
const wpRestBase = window.nfdOnboarding.restUrl;
const onboardingRestRoute = 'newfold-onboarding/v1';
const onboardingRestBase = `${wpRestBase}/${onboardingRestRoute}`;

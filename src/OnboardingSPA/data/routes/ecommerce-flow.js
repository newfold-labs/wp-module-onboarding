...
export const steps = [
    {
        path: '/ecommerce/step/get-started',
    ...
    {
        path: '/ecommerce/step/top-priority',
    ...
    {
        path: '/ecommerce/step/basic-info',
    ...
    {
        path: '/ecommerce/step/design/themes',
    ...
    {
        path: '/ecommerce/step/design/theme-styles',
    ...
    {
        path: '/ecommerce/step/design/colors',
    ...
    {
        path: '/ecommerce/step/design/typography',
    ...
    {
        path: '/ecommerce/step/design/header-menu',
    ...
    {
        path: '/ecommerce/step/site-features',
    ...
    {
        path: '/ecommerce/step/site-pages',

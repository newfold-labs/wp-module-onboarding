    ...
    return (
        <CommonLayout isBgPrimary isCentered>
            <NewfoldLargeCard className="chapter-interstitial">
                <CardHeader heading={content.heading} subHeading={content.subheading} />
                <div className="chapter-interstitial__content">
                    <div className="chapter-interstitial__content__column-left">
                        <h2 className='chapter-interstitial__content__column-left__heading'>{content.content.heading}</h2>
                        <p className='chapter-interstitial__content__column-left__question1'>{content.content.question1}</p>
                        <p className='chapter-interstitial__content__column-left__question2'>{content.content.question2}</p>
                        <h2 className='chapter-interstitial__content__column-left__heading'>{content.content.redirectMessage}<br /> {countdown}</h2>
                    </div>
                    <div className="chapter-interstitial__content__column-right">
                    </div>
                </div>
                <div className='chapter-interstitial__buttons'>
                    <ButtonBlue onClick={ () => saveDataAndExit() } text={content.buttons.button1.text} className={'chapter-interstitial__buttons--blue'} />
                    <ButtonWhite onClick={ () => navigate( nextStep.path ) } text={<><b className='chapter-interstitial__buttons--white__text'>{content.buttons.button2.text}</b><Icon className='chapter-interstitial__buttons--white__icon'icon={chevronRight} /></>} className={'chapter-interstitial__buttons--white'}/>
                </div>
            </NewfoldLargeCard>
        </CommonLayout>
    );

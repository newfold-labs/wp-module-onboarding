	...
	return (
		<Animate type={ 'fade-in' } duration="100ms" timingFunction="ease-in">
			<DrawerPanelHeader
				...
				subheading={ __(
					'Our commerce steps streamline store setup by collecting essential details like address and product info. Start selling seamlessly, ensuring your online business thrives from the get-go.',

	...
	return (
		...
		>
			<div className="nfd-flex nfd-items-center nfd-justify-center nfd-text-center nfd-gap-3">
				<ArrowsRightLeftIcon className="nfd-w-5 sm:nfd-w-6 nfd-h-5 sm:nfd-h-6 nfd-text-content-primary" />
				<span className="nfd-text-base sm:nfd-text-lg md:nfd-text-xl nfd-font-medium nfd-text-content-primary">

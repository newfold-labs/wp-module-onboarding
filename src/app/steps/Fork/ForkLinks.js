		...
		if ( canMigrateSite || migrationFallbackUrl ) {
			return (
				<ActionCard
					...
					className="nfd-flex nfd-items-center nfd-justify-center nfd-gap-2 nfd-text-center nfd-text-base nfd-text-content-default nfd-bg-transparent nfd-py-3 nfd-px-12 nfd-border-2 nfd-border-gray-800 nfd-rounded-md hover:nfd-bg-transparent nfd-font-semibold"
				>

const site_config_mock = require('../../fixtures/site');
...
export const apiList = {
    sitegen: '/index.php?rest_route=%2Fnewfold-onboarding%2Fv1%2Fsitegen%2Fgenerate&flow=sitegen&_locale=user',
    homepages: '/index.php?rest_route=%2Fnewfold-onboarding%2Fv1%2Fsitegen%2Fhomepages&flow=sitegen&_locale=user',
...
export const siteGenMockAll = ( req ) => {
    ...
    sitegen_identifiers.forEach((identifierKey, index) => {
        if (requestBody.hasOwnProperty('identifier') && requestBody.identifier == identifierKey) {

...
class CompatibilityScanWPUnitTest extends \lucatume\WPBrowser\TestCase\WPTestCase {
	...
	/**
	 * Default config and test statuses.
	 *
	 * @return void
	 */
	...
	/**
	 * Scan against current wp evaluates to compatible.
	 *
	 * @return void
	 */
	...
	/**
	 * Scan with higher min wp evaluates to unsupported.
	 *
	 * @return void
	 */
	...
	/**
	 * Custom config is merged with defaults.
	 *
	 * @return void
	 */

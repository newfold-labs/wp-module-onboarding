...
class DesignController extends WP_REST_Controller {
    ...
    protected function get_color_palettes_from_options($page, $per_page) {
        ...
        foreach ($color_palettes as $index => $palette) {
            ...
            $formatted_palettes[] = array(
                ...
                'displayColors' => array(
                    array('color' => $palette['base'], 'name' => 'Base', 'slug' => 'base'),
                    array('color' => $palette['contrast'], 'name' => 'Contrast', 'slug' => 'contrast'),
                    array('color' => $palette['primary'], 'name' => 'Primary', 'slug' => 'primary'),
                    array('color' => $palette['secondary'], 'name' => 'Secondary', 'slug' => 'secondary')
                ),
    ...
    protected function fetch_from_hiive($endpoint) {
        ...
        $response = wp_remote_get($this->hiive_api_base . $endpoint, array(
            'timeout' => 15,
            'headers' => array(
